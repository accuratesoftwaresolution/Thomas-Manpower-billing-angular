...
@Component({
  selector: 'app-stock-receipt-voucher',
  templateUrl: './stock-receipt-voucher.component.html',
  styleUrls: ['./stock-receipt-voucher.component.scss']
})
export class StockReceiptVoucherComponent implements OnInit {
