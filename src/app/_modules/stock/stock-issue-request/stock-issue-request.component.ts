...
@Component({
  selector: 'app-stock-issue-request',
  templateUrl: './stock-issue-request.component.html',
  styleUrls: ['./stock-issue-request.component.scss']
})
export class StockIssueRequestComponent implements OnInit {
