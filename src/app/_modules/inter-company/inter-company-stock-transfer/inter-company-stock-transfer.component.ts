...
@Component({
  selector: 'app-inter-company-stock-transfer',
  templateUrl: './inter-company-stock-transfer.component.html',
  styleUrls: ['./inter-company-stock-transfer.component.scss']
})
export class InterCompanyStockTransferComponent implements OnInit {
