...
@Component({
  selector: 'app-inter-company-purchase-order',
  templateUrl: './inter-company-purchase-order.component.html',
  styleUrls: ['./inter-company-purchase-order.component.scss']
})
export class InterCompanyPurchaseOrderComponent implements OnInit {
