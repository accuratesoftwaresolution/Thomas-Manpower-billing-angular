...
@Component({
  selector: 'app-inter-company-sales-order',
  templateUrl: './inter-company-sales-order.component.html',
  styleUrls: ['./inter-company-sales-order.component.scss']
})
export class InterCompanySalesOrderComponent implements OnInit {
