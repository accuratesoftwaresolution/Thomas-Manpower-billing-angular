...
@Component({
  selector: 'app-prepaid-post-dated-journal-listing',
  templateUrl: './prepaid-post-dated-journal-listing.component.html',
  styleUrls: ['./prepaid-post-dated-journal-listing.component.scss']
})
export class PrepaidPostDatedJournalListingComponent implements OnInit {
