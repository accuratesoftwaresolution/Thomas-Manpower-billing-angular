...
@Component({
  selector: 'app-prepaid-opening-balance',
  templateUrl: './prepaid-opening-balance.component.html',
  styleUrls: ['./prepaid-opening-balance.component.scss']
})
export class PrepaidOpeningBalanceComponent implements OnInit {
