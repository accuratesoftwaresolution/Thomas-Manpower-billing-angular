...
// import { PrepaymentMonthlyEntryTable } from 'src/app/_dto/masters/accural-mapping/PrepaymentMonthlyEntryTable.dto';

@Component({
  selector: 'app-create-prepaid-post-dated-journal',
  templateUrl: './create-prepaid-post-dated-journal.component.html',
  styleUrls: ['./create-prepaid-post-dated-journal.component.scss']
})
export class CreatePrepaidPostDatedJournalComponent implements OnInit {
  ...
  PrepaymentMonthlyEntryTable: any[] = [new TblTransDetailDto()];


  MonthlyEntryTableData = [
    { header: 'Sys ID', hide: false, mandatory: true, width: '3rem', data: '1', manual: false, bind: 'Alld_SysID', type: 'text' },
    { header: 'Prepaid Account SysID', hide: false, mandatory: true, width: '6rem', data: 'A001', manual: false, bind: 'Alld_AccFirst_SysID', type: 'text' },
    { header: 'Prepaid Account Code', hide: false, mandatory: true, width: '10rem', data: 'AC001', manual: true, bind: 'Alld_AccFirst_Code', type: 'text', PopUp: true, PopUpData: 'AccuralAccountFirstCode' },
    { header: 'Prepaid Account Name', hide: false, mandatory: false, width: '12rem', data: 'Cleaning', manual: false, bind: 'Alld_AccFirst_Name', type: 'text' },
    ...
    { header: 'Prepaids Voucher JV SysID', hide: false, mandatory: false, width: '6rem', data: 'JVS001', manual: false, bind: 'Allh_VouJvType_SysID', type: 'text' },
    { header: 'Prepaids Voucher JV Type', hide: false, mandatory: false, width: '8rem', data: 'Standard', manual: false, bind: 'Allh_VouJvType', type: 'text' },
    { header: 'Prepaid JV Number', hide: false, mandatory: false, width: '10rem', data: 'JV1001', manual: false, bind: 'Alld_AccrJv_Number', type: 'text' },
...
//
      ...
      case 'PrepaidMaster':
        this.ReceiptPaymentService.receiptPaymentData.tblTransHead.Allh_Pre_Code = event.HPre_Code
        this.ReceiptPaymentService.receiptPaymentData.tblTransHead.Allh_Pre_Name = event.HPre_Name
        // this.ReceiptPaymentService.receiptPaymentData.voucherSysId = event.sysId
        break;


      case 'AccuralAccountFirstCode':
        this.PrepaymentMonthlyEntryTable[this.tableIndex].Alld_AccFirst_Code = event.HAccOne_Code
        this.PrepaymentMonthlyEntryTable[this.tableIndex].Alld_AccFirst_Name = event.HAccOne_Name
        break;
      case 'AccuralAccountFirstCode2':
        this.PrepaymentMonthlyEntryTable[this.tableIndex].Alld_AccSecond_Code = event.HAccOne_Code
        this.PrepaymentMonthlyEntryTable[this.tableIndex].Alld_AccSecond_Name = event.HAccOne_Name
        break;
      case 'AccuralRemarksCode':
        this.PrepaymentMonthlyEntryTable[this.tableIndex].Alld_Remark_Code = event.HRemMast_Code
        this.PrepaymentMonthlyEntryTable[this.tableIndex].Alld_Remark_Name = event.HRemMast_Name
        break;
...
//
  ...
  deleteRow(table: any, index: number) {
    ...
    if (table == 'PrepaymentMonthlyEntryTable') {
      this.PrepaymentMonthlyEntryTable.splice(index, 1);
    }
  ...
  addRow(table: any, index: number) {
    ...
    if (table == 'PrepaymentMonthlyEntryTable') {
      const newRow = new TblTransDetailDto()
      this.PrepaymentMonthlyEntryTable.splice(index + 1, 0, newRow);
