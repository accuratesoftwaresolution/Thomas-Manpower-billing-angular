...
@Component({
  selector: 'app-accural-opening-balance',
  templateUrl: './accural-opening-balance.component.html',
  styleUrls: ['./accural-opening-balance.component.scss']
})
export class AccuralOpeningBalanceComponent implements OnInit {
