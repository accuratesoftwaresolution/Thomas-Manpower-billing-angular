...
@Component({
  selector: 'app-accrual-post-dated-journal-listing',
  templateUrl: './accrual-post-dated-journal-listing.component.html',
  styleUrls: ['./accrual-post-dated-journal-listing.component.scss']
})
export class AccrualPostDatedJournalListingComponent implements OnInit {
  ...
  TableData = [
    ...
    { header: 'Account Code', hide: false, mandatory: true, width: '8rem', data: '12345678912345', manual: true, PopUp: true, PopUpData: 'AccountFirstCode', bind: "Alld_AccSecond_Code", routeTo: "account-master", type: 'text' },
