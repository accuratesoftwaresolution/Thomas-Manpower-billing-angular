...
@Component({
  selector: 'app-accrual-payment',
  templateUrl: './accrual-payment.component.html',
  styleUrls: ['./accrual-payment.component.scss']
})
export class AccrualPaymentComponent implements OnInit {
