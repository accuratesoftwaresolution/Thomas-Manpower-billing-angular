...
@Component({
  selector: 'app-accrual-post-dated-journal',
  templateUrl: './accrual-post-dated-journal.component.html',
  styleUrls: ['./accrual-post-dated-journal.component.scss']
})
export class AccrualPostDatedJournalComponent implements OnInit {
