...
@Component({
  selector: 'app-prepaid-payments',
  templateUrl: './prepaid-payments.component.html',
  styleUrls: ['./prepaid-payments.component.scss']
})
export class PrepaidPaymentsComponent implements OnInit {
FinanceSteps = [
