...
@Component({
  ...
  styleUrls: ['./excess-stock.component.scss']
})
export class ExcessStockComponent implements OnInit {
      ...
      DebitAccountTableData = [
        { debitAccountCode: 'DA001', debitAccountName: 'Cash' },
        { debitAccountCode: 'DA002', debitAccountName: 'Accounts Receivable' }
      ];
      
      CreditAccountTableData = [
        { creditAccountCode: 'CA001', creditAccountName: 'Sales' },
        { creditAccountCode: 'CA002', creditAccountName: 'Accounts Payable' }
      ];
      
      PartyCodeTableData = [
        { partyCode: 'P001', partyName: 'ABC Corp' },
        { partyCode: 'P002', partyName: 'XYZ Ltd' }
      ];
    ...
    // Data for Debit Account
    DebitAccountData = {
      id: 'DebitAccountCode',
      name: 'Debit Account Details',
      TableData: this.DebitAccountTableData, // Populate this array with actual data
      columns: [
        { header: 'Debit Account Code', field: 'debitAccountCode', width: '2rem' },
        { header: 'Debit Account Name', field: 'debitAccountName', width: '6rem' }
      ]
    };
    
    // Data for Credit Account
    CreditAccountData = {
      id: 'CreditAccountCode',
      name: 'Credit Account Details',
      TableData: this.CreditAccountTableData, // Populate this array with actual data
      columns: [
        { header: 'Credit Account Code', field: 'creditAccountCode', width: '2rem' },
        { header: 'Credit Account Name', field: 'creditAccountName', width: '6rem' }
      ]
    };
    ...
    PartyCodeData = {
      id: 'PartyCode',
      name: 'Party Code Details',
      TableData: this.PartyCodeTableData, // Populate this array with actual data
      columns: [
        { header: 'Party Code', field: 'partyCode', width: '2rem' },
        { header: 'Party Name', field: 'partyName', width: '6rem' }
      ]
    };
        ...
        products: any[] = [{}, {}, {}, {}, {}, {},];
         ...
         TableData = [
          ...
          { field: 'warehouse', header: 'Warehouse', hide: false, mandatory: false, width: '8rem', data: '123456789', manual: true, PopUp: true, PopUpData: 'WarehouseCode' },
    ...
    selectedDebitAccountCode: any;
    selectedDebitAccountNumber: any;
      selectedCreditAccountCode: any;
      selectedCreditAccountName: any;
      selectedDebitAccountName: any;
selectedCOGSAccountCode: any;
selectedCOGSAccountName: any;
selectedStockAccountCode: any;
selectedStockAccountName: any;
        ...
        ShowPopUp(Type, rowData?) {
          ...
          else if (Type === 'DebitAccountCode') {
            this.PopUpData = this.DebitAccountData;
          }
          else if (Type === 'CreditAccountCode') {
            this.PopUpData = this.CreditAccountData;
          }
          else if (Type === 'PartyCode') {
            this.PopUpData = this.PartyCodeData;
          }
        ...
        chooseLookup(selectedRow) {
          ...
          else if (this.PopUpData.id === 'CreditAccountCode') {
            this.selectedCreditAccountCode = selectedRow.creditAccountCode;
            this.selectedCreditAccountName = selectedRow.creditAccountName;
          
            // Handle Party Code selection
          } else if (this.PopUpData.id === 'PartyCode') {
            this.selectedPartyCode = selectedRow.partyCode;
            this.selectedPartyName = selectedRow.partyName;
          }
          else if (this.PopUpData.id === 'DebitAccountCode') {
            this.selectedDebitAccountCode = selectedRow.debitAccountCode;
            this.selectedDebitAccountName = selectedRow.debitAccountName;
