...
@Component({
  selector: 'app-sales-cum-delivery-note',
  templateUrl: './sales-cum-delivery-note.component.html',
  styleUrls: ['./sales-cum-delivery-note.component.scss']
})
export class SalesCumDeliveryNoteComponent implements OnInit {
