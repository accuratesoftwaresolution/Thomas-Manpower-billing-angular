...
@Component({
  selector: 'app-voucher-type-number',
  templateUrl: './voucher-type-number.component.html',
  styleUrls: ['./voucher-type-number.component.scss']
})
export class VoucherTypeNumberComponent implements OnInit {
  ...
  showVocherType:boolean = false;

  showVoucherTypeUser:boolean = false;
