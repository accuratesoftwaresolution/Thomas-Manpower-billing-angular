...
@Component({
  selector: 'app-bom-wo',
  templateUrl: './bom-wo.component.html',
  styleUrls: ['./bom-wo.component.scss']
})
export class BomWoComponent implements OnInit {
  ...
  scrollableTabs: any[] = [
    { title: "BOM Fished Goods Creation", content: "" },
    { title: "PO Numbers", content: "" },
    { title: "BOM Multiple Production Process Material", content: "" },
    { title: "BOM Multiple Production Process Packing Material", content: "" },
    { title: "BOM Multiple Production Process Manpower", content: "" },
    { title: "Masters", content: "Content for Masters" },
    { title: "Other Expenses", content: "Content for Other Expenses" },
    { title: "BOM Multiple Production Process Scrap", content: "" },
    { title: "QA/QC", content: "Content for QA/QC" },
    { title: "Costing", content: "Content for Costing" },
  ...
  TableData = [
    ...
    { field: 'fishedGoodsTypeCode', header: 'Fished Goods Type Code', hide: false, mandatory: true, width: '8rem', data: '12345678912345', manual: true, PopUp: true, PopUpData: 'FishedGoodsTypeCode' },
    { field: 'fishedGoodsTypeName', header: 'Fished Goods Type Name', hide: false, mandatory: false, width: '16rem', data: '123456789123456789123456789', manual: false },
    ...
    { field: 'fishedProductCode', header: 'Fished Product Code', hide: false, mandatory: true, width: '8rem', data: '12345678912345', manual: true, PopUp: true, PopUpData: 'FishedProductCode' },
    { field: 'fishedProductName', header: 'Fished Product Name', hide: false, mandatory: false, width: '16rem', data: '123456789123456789123456789', manual: false },
    { field: 'fishedProductLongName', header: 'Fished Product Long Name', hide: false, mandatory: false, width: '16rem', data: '123456789123456789123456789', manual: false },
    ...
    { field: 'expectedSellingPrice', header: 'Expected Selling Price', hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: true },
    ...
    { field: 'closeLink', header: 'Close Link', hide: false, mandatory: false, width: '10rem', data: '123456789123456789', manual: false }
  ];
