...
import { TblHTaxCouMasDto } from 'src/app/_dto/masters/tblHTaxCouMas.dto';

@Component({
  selector: 'app-tax-country',
  templateUrl: './tax-country.component.html',
  styleUrls: ['./tax-country.component.scss']
})
export class TaxCountryComponent implements OnInit {
  ...
  taxData : TblHTaxCouMasDto = new TblHTaxCouMasDto()
