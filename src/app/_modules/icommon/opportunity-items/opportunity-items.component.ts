...
@Component({
  selector: 'app-opportunity-items',
  templateUrl: './opportunity-items.component.html',
  styleUrls: ['./opportunity-items.component.scss']
})
export class OpportunityItemsComponent implements OnInit {
