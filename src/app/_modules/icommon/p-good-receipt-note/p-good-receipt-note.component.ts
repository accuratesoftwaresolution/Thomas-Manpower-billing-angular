...
@Component({
  selector: 'app-p-good-receipt-note',
  templateUrl: './p-good-receipt-note.component.html',
  styleUrls: ['./p-good-receipt-note.component.scss']
})
export class PGoodReceiptNoteComponent implements OnInit {
