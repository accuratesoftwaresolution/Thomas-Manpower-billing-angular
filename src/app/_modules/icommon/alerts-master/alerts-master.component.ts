...
@Component({
  selector: 'app-alerts-master',
  templateUrl: './alerts-master.component.html',
  styleUrls: ['./alerts-master.component.scss']
})
export class AlertsMasterComponent implements OnInit {
