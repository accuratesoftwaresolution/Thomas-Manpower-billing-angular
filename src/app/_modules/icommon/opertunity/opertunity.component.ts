...
@Component({
  selector: 'app-opertunity',
  templateUrl: './opertunity.component.html',
  styleUrls: ['./opertunity.component.scss']
})
export class OpertunityComponent implements OnInit {
  ...
  scrollableTabs: any[] = [
    ...
    { title: "Stages", content: "" },
    { title: "Partners", content: "" },
    { title: "Competitors", content: "" },
    { title: "Summary", content: "" },
    { title: "Opportunity items", content: "" },
  ...
  goToOpportunity(){
    ...
    this.router.navigate(['/common/opportunity-items'])
  }
}
