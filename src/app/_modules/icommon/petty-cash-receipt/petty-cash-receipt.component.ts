...
@Component({
  selector: 'app-petty-cash-receipt',
  templateUrl: './petty-cash-receipt.component.html',
  styleUrls: ['./petty-cash-receipt.component.scss']
})
export class PettyCashReceiptComponent implements OnInit {
