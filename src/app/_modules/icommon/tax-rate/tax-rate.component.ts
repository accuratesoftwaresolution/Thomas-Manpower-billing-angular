...
export class TaxRateComponent implements OnInit {
  ...
  chosenTaxRate: any = null;

  chosenTaxType: any = null;

  chooseAccountType: any = null;
  ...
  chooseTaxRate(i){
    this.chosenTaxRate = 'Tax Rate '+i
    this.showTaxRate = !this.showTaxRate
  }
  
  chooseTaxType(i){
    this.chosenTaxType = 'Tax type '+i
    this.showTaxType = !this.showTaxType
  }

  chooseAccount(i){
    this.chooseAccountType = 'Account type '+i
