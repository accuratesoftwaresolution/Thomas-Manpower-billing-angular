...
@Component({
  selector: 'app-master-document-atttach',
  templateUrl: './master-document-atttach.component.html',
  styleUrls: ['./master-document-atttach.component.scss']
})
export class MasterDocumentAtttachComponent implements OnInit {
  isUploading = false;
