...
@Component({
  selector: 'app-crm-business-partner',
  templateUrl: './crm-business-partner.component.html',
  styleUrls: ['./crm-business-partner.component.scss']
})
export class CrmBusinessPartnerComponent implements OnInit {
  ...
  scrollableTabs: any[] = [
    ...
    { title: "Contact Persons", content: "" },
    { title: "Addresses", content: "" },
    { title: "Payment Terms", content: "" },
    { title: "Payment Run", content: "" },
    { title: "Accounting", content: "" },
