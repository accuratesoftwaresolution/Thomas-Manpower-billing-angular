...
@Component({
  selector: 'app-petty-cash-payments',
  templateUrl: './petty-cash-payments.component.html',
  styleUrls: ['./petty-cash-payments.component.scss']
})
export class PettyCashPaymentsComponent implements OnInit {
