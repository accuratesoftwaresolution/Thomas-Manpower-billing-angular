...
@Component({
  selector: 'app-warehouse-issue',
  templateUrl: './warehouse-issue.component.html',
  styleUrls: ['./warehouse-issue.component.scss']
})
export class WarehouseIssueComponent implements OnInit {
