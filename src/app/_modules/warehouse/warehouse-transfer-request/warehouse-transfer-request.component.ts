...
@Component({
  selector: 'app-warehouse-transfer-request',
  templateUrl: './warehouse-transfer-request.component.html',
  styleUrls: ['./warehouse-transfer-request.component.scss']
})
export class WarehouseTransferRequestComponent implements OnInit {
...
FinanceSteps = [
  ...
  selectedItem(event: any) {
    ...
    switch (Type) {
      ...
      // case 'FieldAlertCode':
      //   this._stockService.stockData.tblFieldMaster[this.tableIndex].HField_Alert_Code = event.alertsMasterCode
      //   this._stockService.stockData.tblFieldMaster[this.tableIndex].HField_Alert_Name = event.alertsName
      //   break;
      // case 'FieldNarrationCode':
      //   this._stockService.stockData.tblFieldMaster[this.tableIndex].HField_Narration_Code = event.narrationMasterCode
      //   this._stockService.stockData.tblFieldMaster[this.tableIndex].HField_Narration_Name = event.narrationMasterName
      //   break;
