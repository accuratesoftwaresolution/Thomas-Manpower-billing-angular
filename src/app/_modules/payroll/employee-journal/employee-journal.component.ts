...
export class EmployeeJournalComponent implements OnInit {
  ...
  TableData = [
    ...
    { header: 'Taxable Type Code(Taxable/Non Taxable', hide: false, mandatory: false, width: '8rem', data: '123456789', manual: false, bind: "Alld_TaxType_Code", type: 'text', PopUp: true, PopUpData: 'TaxableTypeCode' },
    { header: 'Taxable Type Name(Taxable/Non Taxable)', hide: false, mandatory: false, width: '12rem', data: '123456789', manual: false, bind: "Alld_TaxType_Name", type: 'text' },
    ...
    if (table == 'ReceiptPaymentService.receiptPaymentData.tblTransDetail') {
      ...
      this.confirmationService.confirm({
        ...
        accept: () => {
          if (table === 'ReceiptPaymentService.receiptPaymentData.tblTransDetail') {
            this.ReceiptPaymentService.receiptPaymentData.tblTransDetail.splice(index, 1);
            if (this.ReceiptPaymentService.receiptPaymentData.tblTransDetail.length === 0) {
              this.addRow1('ReceiptPaymentService.receiptPaymentData.tblTransDetail', -1);
            }
          }
        }
      });
