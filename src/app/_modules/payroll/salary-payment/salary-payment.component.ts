...
export class SalaryPaymentComponent implements OnInit {
  ...
  TableData = [
    ...
    { header: 'Account Code', hide: false, mandatory: true, width: '10rem', data: '12345678912345', manual: true, PopUp: true, PopUpData: 'DetailAccountCode', bind: "Alld_AccSecond_Code", routeTo: "account-master", type: 'text' },
    ...
    { header: 'Employee SysID', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: "Alld_SalEmpl_SysID", type: 'text' },
    { header: 'Employee Code', PopUp: true, PopUpData: 'EmployeeCode', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: "Alld_SalEmpl_Code", type: 'text' },
    ...
    { header: 'Taxable Type Code', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: "Alld_TaxType_Code", type: 'text', PopUp: true, PopUpData: 'TaxableTypeCode' },
    { header: 'Taxable Type Name', hide: false, mandatory: false, width: '16rem', data: '123456789', manual: false, bind: "Alld_TaxType_Name", type: 'text' },
    ...
    { header: 'Reference', PopUp: true, PopUpData: 'ReferanceCode', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: "Alld_Reference", type: 'text' },
    ...
    { header: 'Link Voucher No. 01', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: "Alld_Link_One", type: 'text' },
    { header: 'Link Voucher No. 02', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: "Alld_Link_Two", type: 'text' },
    { header: 'Link Voucher No. 03', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: "Alld_Link_Three", type: 'text' },
    { header: 'Tax Code', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: "Alld_Tax_Code", type: 'text' },
    { header: 'Tax Name', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: "Alld_Tax_Nam", type: 'text' },
    { header: 'Tax Rate Input (%)', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: "Alld_InPut_Perc", type: 'number' },
    { header: 'Tax Rate Output  (%)', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: "Alld_OutPut_Perc", type: 'number' },
    { header: 'Tax Amount', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: "Alld_Tax_Amount", type: 'number' },
    { header: 'Total Amount', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: "Alld_Total_Amount", type: 'number' },
    { header: 'Tax Reference', PopUp: true, PopUpData: 'TaxReferanceCode', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: "Alld_Tax_Reference", type: 'text' },
    { header: 'Remarks Code', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: "Alld_Remark_Code", type: 'text', PopUp: true, PopUpData: 'RemarksCode' },
    { header: 'Remarks Name', hide: false, mandatory: false, width: '16rem', data: '123456789', manual: false, bind: "Alld_Remark_Name", type: 'text' }
  ];
