...
export class EmployeeAttendanceComponent implements OnInit {
  ...
  main: TblSecTransDetailDto[] = [new TblSecTransDetailDto(), new TblSecTransDetailDto(), new TblSecTransDetailDto()]
  ...
  scrollableTabs: any[] = [
    ...
    { id: 2, title: "Payment Terms", content: "", visible: false }, // Hidden tab example
  ...
  TableData = [
    ...
    { header: 'Atten_SysID', bind: "Alld_SysID", hide: false, mandatory: false, width: '8rem', data: "12345", manual: false, type: 'number' },
    { header: 'Employee SysID', bind: "Alld_Empl_SysID", hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: false, PopUp: false, type: 'number' },
    { header: 'Employee Code', bind: "Alld_Empl_Code", PopUp: true, PopUpData: 'EmployeeCode', hide: false, mandatory: false, width: '8rem', data: '123456789', manual: false, type: 'text' },
    { header: 'Employee Name', bind: "Alld_Empl_Name", hide: false, mandatory: false, width: '16rem', data: '123456789123456789123456789', manual: false, type: 'text' },
    { header: 'Month Days', bind: "Alld_Month_Days", hide: false, mandatory: false, width: '8rem', data: '123456', manual: false, affects: ['Alld_Gross_Amount', 'Alld_Net_Amount'], align: 'left', type: 'number' },
    { header: 'Work Days', bind: "Alld_Work_Days", hide: false, mandatory: false, width: '8rem', data: '123456', manual: false, affects: ['Alld_Gross_Amount', 'Alld_Net_Amount'], align: 'left', type: 'number' },
    { header: 'Leave with Pay', bind: "Alld_LeaveWith_Pay", hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: false, affects: ['Alld_Gross_Amount', 'Alld_Net_Amount'], align: 'left', type: 'number' },
    { header: 'Leave without Pay', bind: "Alld_LeaveWithOut_Pay", hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: false, align: 'left', type: 'number' },
    { header: 'Total Days', bind: "Alld_Total_Days", hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: false, readOnly: false, align: 'center', type: 'number' },
    { header: 'Total  Paid Days', bind: "Alld_LeavePaid_Days", hide: false, mandatory: false, width: '8rem', data: '123456789', manual: false, type: 'number' },
    { header: 'Total Un Paid Days', bind: "Alld_LeaveUnPaid_Days", hide: false, mandatory: false, width: '8rem', data: '123456789', manual: false, type: 'number' },
    { header: 'Overtime Hours', bind: "Alld_OT_Hrs", hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: false, align: 'left', type: 'number' },
  ...
  selectedItem(event: any) {
    ...
    switch (Type) {
      ...
      case 'EmployeeCode':
        this.main[this.tableIndex].Alld_Empl_Code = event.DLSum_Emp_Code
        this.main[this.tableIndex].Alld_Empl_Name = event.DLSum_Emp_Name

      case 'RemarkCode':
        this.main[this.tableIndex].Alld_Remark_Code = event.HRemark_Code
        this.main[this.tableIndex].Alld_Remark_Name = event.HRemark_Name
      ...
      case 'JurisdictionCode':
        ...
        break;
      // case 'PostingHCode':
      //   this._salesService.headerData.tblHPosting[this.tableIndex].postingHeaderCode = event.postingHCode
      //   this._salesService.headerData.tblHPosting[this.tableIndex].postingHeaderName = event.postingHName
      //   this._salesService.headerData.tblHPosting[this.tableIndex].postingSQLFieldName = event.postingSQLFieldName
      //   this._salesService.headerData.tblHPosting[this.tableIndex].PostingFormula = event.postingFormula
      //   this._salesService.headerData.tblHPosting[this.tableIndex].PostingSymbol = event.postingSymbol
      //   this._salesService.headerData.tblHPosting[this.tableIndex].PostingAmount = event.postingAmount
      //   break;
      // case 'PostingDCode':
      //   this._salesService.headerData.tblDPosting[this.tableIndex].postingDetailCode = event.postingDCode
      //   this._salesService.headerData.tblDPosting[this.tableIndex].postingDetailName = event.postingDName
      //   this._salesService.headerData.tblDPosting[this.tableIndex].postingSQLFieldName = event.postingSQLFieldName
      //   this._salesService.headerData.tblDPosting[this.tableIndex].PostingFormula = event.postingFormula
      //   this._salesService.headerData.tblDPosting[this.tableIndex].PostingSymbol = event.postingSymbol
      //   this._salesService.headerData.tblDPosting[this.tableIndex].PostingAmount = event.postingAmount
      //   break;
      // case 'DebitAccountFirstCode':
      //   this._salesService.headerData.tblDPosting[this.tableIndex].debitAccountFirstCode = event.debitAccountFirstCode
      //   this._salesService.headerData.tblDPosting[this.tableIndex].debitAccountFirstName = event.debitAccountFirstName
      //   break;
      // case 'CreditAccountSecondCode':
      //   this._salesService.headerData.tblDPosting[this.tableIndex].creditAccountSecondCode = event.creditAccountSecondCode
      //   this._salesService.headerData.tblDPosting[this.tableIndex].creditAccountSecondName = event.creditAccountSecondName
      //   break;
...
//
    ...
    console.log("trans Details  == ", this._salesService.headerData.tblTransDetail);
  ...
  toggleSelectAll(event: any) {
    ...
    this.main.forEach(row => {
      row.selected = isChecked;
    });
  }

  isAllSelected(table?): boolean {
    return this.main.every(row => row.selected);
  }
...
//
  ...
  addRow(table: any, index: number) {
    if (table == 'main') {
      ...
      this.main.splice(index + 1, 0, newRow);
