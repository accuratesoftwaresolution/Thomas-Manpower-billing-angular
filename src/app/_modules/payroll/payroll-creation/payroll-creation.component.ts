...
@Component({
  selector: 'app-payroll-creation',
  templateUrl: './payroll-creation.component.html',
  styleUrls: ['./payroll-creation.component.scss']
})
export class PayrollCreationComponent implements OnInit {
  ...
  TableData = [
    ...
    { header: 'Employee SysID', hide: false, mandatory: true, width: '8rem', data: '12345678912345', manual: true, bind: "Alld_Empl_SysID", routeTo: "account-master", type: 'text' },
    { header: 'Employee Code', PopUp: true, PopUpData: 'EmployeeCode', hide: false, mandatory: false, width: '8rem', data: '123456789123456789123456789', manual: false, bind: "Alld_Empl_Code", type: 'text' },
    { header: 'Employee Name', hide: false, mandatory: false, width: '16rem', data: '123456789', manual: false, bind: "Alld_Empl_Name", type: 'text' },
    { header: 'Month Days', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: "Alld_Month_Days", type: 'text' },
    { header: 'Paid Days', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: 'Alld_Paid_Days', type: 'number', affects: ['Alld_Debit_Amount'], readOnly: false },
    { header: 'Addition SysID', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: 'Alld_SalAdd_SysID', type: 'number' },

    { header: 'Addition Code', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: "Alld_SalAdd_Code", type: 'text', PopUp: true, PopUpData: 'AdditionCode' },
    { header: 'Addition Name', hide: false, mandatory: false, width: '16rem', data: '123456789', manual: false, bind: "Alld_SalAdd_Name", type: 'text' },
    { header: 'Debit Amount', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: "Alld_Debit_Amount", type: 'text' },
    { header: 'Deduction SysID', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: "Alld_SalDedu_SysID", type: 'text' },
    { header: 'Deduction   Code', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: "Alld_SalDedu_Code", type: 'text' },
    { header: 'Deduction   Name', hide: false, mandatory: false, width: '16rem', data: '1234567109', manual: false, bind: "Alld_SalDedu_Name", type: 'text' },
    ...
    { header: 'Net Salary', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: "Alld_Net_Salary", type: 'text' },
  ...
  selectedItem(event: any) {
    ...
    switch (Type) {
      ...
      case 'EmployeeCode':
        this.ReceiptPaymentService.receiptPaymentData.tblTransDetail[this.tableIndex].Alld_Empl_Code = event.DLSum_Emp_Code
        this.ReceiptPaymentService.receiptPaymentData.tblTransDetail[this.tableIndex].Alld_Empl_Name = event.DLSum_Emp_Name
