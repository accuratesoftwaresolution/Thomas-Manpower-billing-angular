...
@Component({
  selector: 'app-material-receipt-voucher',
  templateUrl: './material-receipt-voucher.component.html',
  styleUrls: ['./material-receipt-voucher.component.scss']
})
export class MaterialReceiptVoucherComponent implements OnInit {
 TransactionSteps = [
