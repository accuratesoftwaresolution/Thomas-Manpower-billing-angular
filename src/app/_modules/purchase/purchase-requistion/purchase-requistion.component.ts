...
@Component({
  selector: 'app-purchase-requistion',
  templateUrl: './purchase-requistion.component.html',
  styleUrls: ['./purchase-requistion.component.scss']
})
export class PurchaseRequistionComponent implements OnInit {
