...
@Component({
  selector: 'app-inventory-opening-entry',
  templateUrl: './inventory-opening-entry.component.html',
  styleUrls: ['./inventory-opening-entry.component.scss']
})
export class InventoryOpeningEntryComponent implements OnInit {
