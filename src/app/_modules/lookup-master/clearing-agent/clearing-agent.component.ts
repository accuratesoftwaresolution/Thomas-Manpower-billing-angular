...
import { TblClearingAgentDto } from 'src/app/_dto/masters/tblclearingagent.dto';
...
export class ClearingAgentComponent implements OnInit {
 ...
 showAmendment: boolean = false;
  ...
  clearingAgent: TblClearingAgentDto = new TblClearingAgentDto()
