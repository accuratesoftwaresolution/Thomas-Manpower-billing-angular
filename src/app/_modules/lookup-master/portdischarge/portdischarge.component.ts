...
import { TblPortOfDischargeDto } from 'src/app/_dto/masters/tblportdischarge.dto';
...
@Component({
  selector: 'app-portdischarge',
  templateUrl: './portdischarge.component.html',
  styleUrls: ['./portdischarge.component.scss']
})
export class PortdischargeComponent implements OnInit {
  ...
  portDischarge: TblPortOfDischargeDto = new TblPortOfDischargeDto()
