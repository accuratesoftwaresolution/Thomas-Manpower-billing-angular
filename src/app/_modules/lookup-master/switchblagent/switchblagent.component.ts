...
import { SwitchBlAgentDto } from 'src/app/_dto/masters/tblswitchblagent.dto';
...
@Component({
  selector: 'app-switchblagent',
  templateUrl: './switchblagent.component.html',
  styleUrls: ['./switchblagent.component.scss']
})
export class SwitchblagentComponent implements OnInit {
  ...
  switchBLAgent: SwitchBlAgentDto = new SwitchBlAgentDto()
