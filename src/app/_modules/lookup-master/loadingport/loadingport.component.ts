...
import { TblLoadingPortDto } from 'src/app/_dto/masters/tblloadport.dto';
import { CommonPopupService } from 'src/app/_providers/common-popup.service';
import { LookupDialogService } from 'src/app/_providers/popup.service';
import { SalesService } from 'src/app/_providers/sales.service';

@Component({
  selector: 'app-loadingport',
  templateUrl: './loadingport.component.html',
  styleUrls: ['./loadingport.component.scss']
})
export class LoadingportComponent implements OnInit {
...
showAmendment: boolean = false;
  ...
  loadingPort : TblLoadingPortDto = new TblLoadingPortDto()
