...
@Component({
  selector: 'app-account-document-attachment',
  templateUrl: './account-document-attachment.component.html',
  styleUrls: ['./account-document-attachment.component.scss']
})
export class AccountDocumentAttachmentComponent implements OnInit {
