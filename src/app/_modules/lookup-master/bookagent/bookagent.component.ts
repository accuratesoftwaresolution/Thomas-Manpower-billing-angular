...
import { TblBookingAgentDto } from 'src/app/_dto/masters/tblbookagent.dto';
import { CommonPopupService } from 'src/app/_providers/common-popup.service';
import { LookupDialogService } from 'src/app/_providers/popup.service';
import { SalesService } from 'src/app/_providers/sales.service';

@Component({
  selector: 'app-bookagent',
  templateUrl: './bookagent.component.html',
  styleUrls: ['./bookagent.component.scss']
})
export class BookagentComponent implements OnInit {
...
showAmendment: boolean = false;
  ...
  bookingAgent : TblBookingAgentDto = new TblBookingAgentDto()
