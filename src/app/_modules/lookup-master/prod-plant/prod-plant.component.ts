...
import { TblProductionPlantDto } from 'src/app/_dto/masters/tblproductionplant.dto';
import { CommonPopupService } from 'src/app/_providers/common-popup.service';
import { LookupDialogService } from 'src/app/_providers/popup.service';
import { SalesService } from 'src/app/_providers/sales.service';

@Component({
  selector: 'app-prod-plant',
  templateUrl: './prod-plant.component.html',
  styleUrls: ['./prod-plant.component.scss']
})
export class ProdPlantComponent implements OnInit {
 ...
 showAmendment: boolean = false;
  ...
  prodPlant : TblProductionPlantDto = new TblProductionPlantDto()
