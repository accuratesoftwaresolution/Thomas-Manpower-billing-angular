...
import { TblTransitPortDto } from 'src/app/_dto/masters/tbltransitport.dto';
import { CommonPopupService } from 'src/app/_providers/common-popup.service';
import { LookupDialogService } from 'src/app/_providers/popup.service';
import { SalesService } from 'src/app/_providers/sales.service';

@Component({
  selector: 'app-transitport',
  templateUrl: './transitport.component.html',
  styleUrls: ['./transitport.component.scss']
})
export class TransitportComponent implements OnInit {
...
showAmendment: boolean = false;
  ...
  transitPort : TblTransitPortDto = new TblTransitPortDto()
