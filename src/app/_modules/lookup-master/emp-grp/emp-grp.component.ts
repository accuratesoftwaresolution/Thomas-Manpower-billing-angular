...
@Component({
  selector: 'app-emp-grp',
  templateUrl: './emp-grp.component.html',
  styleUrls: ['./emp-grp.component.scss']
})
export class EmpGrpComponent implements OnInit {
 ...
 showAmendment: boolean = false;
  ...
  empGrp: EmployeeGroupDto = new EmployeeGroupDto()
