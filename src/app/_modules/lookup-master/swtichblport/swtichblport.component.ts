...
import { SwitchBlPortDto } from 'src/app/_dto/masters/tblswitchblport.dto';
...
@Component({
  selector: 'app-swtichblport',
  templateUrl: './swtichblport.component.html',
  styleUrls: ['./swtichblport.component.scss']
})
export class SwtichblportComponent implements OnInit {
  ...
  switchBLPort: SwitchBlPortDto = new SwitchBlPortDto()
