...
import { TblShippingLineDto } from 'src/app/_dto/masters/tblshopline.dto';
import { CommonPopupService } from 'src/app/_providers/common-popup.service';
import { LookupDialogService } from 'src/app/_providers/popup.service';
import { SalesService } from 'src/app/_providers/sales.service';

@Component({
  selector: 'app-shipline',
  templateUrl: './shipline.component.html',
  styleUrls: ['./shipline.component.scss']
})
export class ShiplineComponent implements OnInit {
...
showAmendment: boolean = false;
  ...
  shippingLine : TblShippingLineDto = new TblShippingLineDto()
