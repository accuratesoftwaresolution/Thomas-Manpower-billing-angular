...
@Component({
  selector: 'app-loan-journal',
  templateUrl: './loan-journal.component.html',
  styleUrls: ['./loan-journal.component.scss']
})
export class LoanJournalComponent implements OnInit {
...
ReferenceAllocationData = {
  ...
  scrollableTabs: any[] = [
    ...
    // { title: "PO Numbers", content: "" },
    // { title: "Tax", content: "" },
    { title: "Masters", content: "" },
    { title: "Other Fields", content: "" },
    { title: "User Key", content: "" },
    // { title: "QA/QC", content: "" },
    // { title: "WH Management", content: "" },
    { title: "Document Attachment", content: "" },
    { title: "Inter Company", content: "" },
    { title: "Field Hide or Display", content: "" },
    { title: "DigiTab", content: "" }
];
  ...
  TableData = [
    { field: 'sysId', header: 'Sys ID', hide: false, mandatory: true, width: '8rem', data: '12345678912345', manual: false },
    { field: 'serialNo', header: 'S. No', hide: false, mandatory: true, width: '8rem', data: '12345678912345', manual: false },
    { field: 'accountCode', header: 'Account Code', hide: false, mandatory: true, width: '8rem', data: '12345678912345', manual: true },
    { field: 'accountName', header: 'Account Name', hide: false, mandatory: true, width: '16rem', data: '123456789123456789123456789', manual: false },
    { field: 'debitAmount', header: 'Debit Amount', hide: false, mandatory: true, width: '8rem', data: '12345678912345', manual: true },
    { field: 'creditAmount', header: 'Credit Amount', hide: false, mandatory: true, width: '8rem', data: '12345678912345', manual: true },
    { field: 'reference', header: 'Reference', hide: false, mandatory: true, width: '8rem', data: '12345678912345', manual: true, PopUp: true, PopUpData: 'AccountCode'},
    { field: 'interCoTransactions', header: 'Inter Co Transactions', hide: false, mandatory: false, width: '16rem', data: '123456789123456789123456789', manual: true },
    { field: 'yn', header: 'Yn', hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: true },
    { field: 'interCoVoucherType', header: 'Inter Co Voucher Type', hide: false, mandatory: false, width: '16rem', data: '123456789123456789123456789', manual: true },
    { field: 'linkVoucherNumber01', header: 'Link Voucher Number 01', hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: true },
    { field: 'linkVoucherNumber02', header: 'Link Voucher Number 02', hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: true },
    { field: 'linkVoucherNumber03', header: 'Link Voucher Number 03', hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: true },
    { field: 'taxCode', header: 'Tax Code', hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: false },
    ...
    { field: 'taxAmount', header: 'Tax Amount', hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: true },
    { field: 'totalAmount', header: 'Total Amount', hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: true },
    { field: 'taxReference', header: 'Tax Reference', hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: true, PopUp: true, PopUpData: 'AccountCode' },
