...
@Component({
  selector: 'app-loan-opening-balance',
  templateUrl: './loan-opening-balance.component.html',
  styleUrls: ['./loan-opening-balance.component.scss']
})
export class LoanOpeningBalanceComponent implements OnInit {
...
ReferenceAllocationData = {
  ...
  TableData = [
    ...
    { field: 'loanCode', header: 'Loan Code', hide: false, mandatory: true, width: '8rem', data: '12345678912345', manual: true },
