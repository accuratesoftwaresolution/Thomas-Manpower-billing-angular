...
@Component({
  selector: 'app-pdp-payment',
  templateUrl: './pdp-payment.component.html',
  styleUrls: ['./pdp-payment.component.scss']
})
export class PdpPaymentComponent implements OnInit {
...
ReferenceAllocationData = {
  ...
  TableData = [
    ...
    { field: 'loanAccountCode', header: 'Loan Account Code', hide: false, mandatory: true, width: '8rem', data: '12345678912345', manual: true },
    { field: 'loanAccountName', header: 'Loan Account Name', hide: false, mandatory: true, width: '16rem', data: '123456789123456789123456789', manual: false },
    { field: 'loanCode', header: 'Loan Code', hide: false, mandatory: true, width: '8rem', data: '12345678912345', manual: true, PopUp: true, PopUpData: 'AccountCode' },
    { field: 'loanName', header: 'Loan Name', hide: false, mandatory: true, width: '16rem', data: '123456789123456789123456789', manual: false },
    { field: 'amount', header: 'Amount', hide: false, mandatory: true, width: '8rem', data: '12345678912345', manual: true },
    { field: 'nextLoanPaymentDate', header: 'Next Loan Payment Date', hide: false, mandatory: false, width: '10rem', data: '12345678912345', manual: true },
  ...
  SubMainTabData = [
    {
      ...
      loanInterestAmount: '50.00',
      listPdcPayments: 'PDC001',
      remarksCode: 'RC001',
      remarksName: 'Monthly Payment'
    },
    {
      categorySysID: 'CS002',
      scheduleDate: '2024-11-20',
      loanPaymentAmount: '2000.00',
      loanInterestAmount: '75.00',
      listPdcPayments: 'PDC002',
      remarksCode: 'RC002',
      remarksName: 'Quarterly Payment'
    },
    {
      categorySysID: 'CS003',
      scheduleDate: '2024-11-25',
      loanPaymentAmount: '1200.00',
      loanInterestAmount: '40.00',
      listPdcPayments: 'PDC003',
      remarksCode: 'RC003',
      remarksName: 'Yearly Payment'
    },
  ];
