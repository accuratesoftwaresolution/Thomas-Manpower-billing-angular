...
@Component({
  selector: 'app-create-loan-category',
  templateUrl: './create-loan-category.component.html',
  styleUrls: ['./create-loan-category.component.scss']
})
export class CreateLoanCategoryComponent implements OnInit {
  ...
  LoanCategoryTable = [
    {
        ...
        loanBankAccountCode: 'LBAC001',
        loanBankAccountName: 'Loan Bank - Account A',
        loanReceiptAccountCode: 'LRAC001',
        loanReceiptAccount: 'Loan Receipt - Account A',
        loanPaymentAccountCode: 'LPAC001',
        loanPaymentAccountName: 'Loan Payment - Account A',
        loanInterestAccountCode: 'LIAC001',
        loanInterestAccountName: 'Loan Interest - Account A',
        pdpPaymentList: 'PDP001',
    },
    {
        categorySysID: 'CAT002',
        loanBankAccountCode: 'LBAC002',
        loanBankAccountName: 'Loan Bank - Account B',
        loanReceiptAccountCode: 'LRAC002',
        loanReceiptAccount: 'Loan Receipt - Account B',
        loanPaymentAccountCode: 'LPAC002',
        loanPaymentAccountName: 'Loan Payment - Account B',
        loanInterestAccountCode: 'LIAC002',
        loanInterestAccountName: 'Loan Interest - Account B',
        pdpPaymentList: 'PDP002',
    },
    {
        categorySysID: 'CAT003',
        loanBankAccountCode: 'LBAC003',
        loanBankAccountName: 'Loan Bank - Account C',
        loanReceiptAccountCode: 'LRAC003',
        loanReceiptAccount: 'Loan Receipt - Account C',
        loanPaymentAccountCode: 'LPAC003',
        loanPaymentAccountName: 'Loan Payment - Account C',
        loanInterestAccountCode: 'LIAC003',
        loanInterestAccountName: 'Loan Interest - Account C',
        pdpPaymentList: 'PDP003',
    },
];
