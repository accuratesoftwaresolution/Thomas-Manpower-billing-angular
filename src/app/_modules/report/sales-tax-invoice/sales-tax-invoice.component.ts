...
@Component({
  selector: 'app-sales-tax-invoice',
  templateUrl: './sales-tax-invoice.component.html',
  styleUrls: ['./sales-tax-invoice.component.scss']
})
export class SalesTaxInvoiceComponent implements OnInit {
