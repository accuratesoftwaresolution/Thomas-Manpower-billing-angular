...
@Component({
  selector: 'app-profit-and-lose-acc',
  templateUrl: './profit-and-lose-acc.component.html',
  styleUrls: ['./profit-and-lose-acc.component.scss']
})
export class ProfitAndLoseAccComponent implements OnInit {
