...
@Component({
  selector: 'app-pdc-receipt-voucher',
  templateUrl: './pdc-receipt-voucher.component.html',
  styleUrls: ['./pdc-receipt-voucher.component.scss']
})
export class PdcReceiptVoucherComponent implements OnInit {
