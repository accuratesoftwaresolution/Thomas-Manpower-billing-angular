...
@Component({
  selector: 'app-salesgroup-by-customer',
  templateUrl: './salesgroup-by-customer.component.html',
  styleUrls: ['./salesgroup-by-customer.component.scss']
})
export class SalesgroupByCustomerComponent implements OnInit {
