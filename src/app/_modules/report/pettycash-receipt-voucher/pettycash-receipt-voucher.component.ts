...
@Component({
  selector: 'app-pettycash-receipt-voucher',
  templateUrl: './pettycash-receipt-voucher.component.html',
  styleUrls: ['./pettycash-receipt-voucher.component.scss']
})
export class PettycashReceiptVoucherComponent implements OnInit {
