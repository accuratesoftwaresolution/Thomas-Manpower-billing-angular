...
@Component({
  selector: 'app-tax-debit-note',
  templateUrl: './tax-debit-note.component.html',
  styleUrls: ['./tax-debit-note.component.scss']
})
export class TaxDebitNoteComponent implements OnInit {
