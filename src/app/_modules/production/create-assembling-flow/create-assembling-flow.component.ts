...
@Component({
  selector: 'app-create-assembling-flow',
  templateUrl: './create-assembling-flow.component.html',
  styleUrls: ['./create-assembling-flow.component.scss']
})
export class CreateAssemblingFlowComponent implements OnInit {
 FinanceSteps = [
