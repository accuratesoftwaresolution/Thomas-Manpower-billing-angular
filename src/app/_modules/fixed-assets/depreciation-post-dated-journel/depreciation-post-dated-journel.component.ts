...
@Component({
  selector: 'app-depreciation-post-dated-journel',
  templateUrl: './depreciation-post-dated-journel.component.html',
  styleUrls: ['./depreciation-post-dated-journel.component.scss']
})
export class DepreciationPostDatedJournelComponent implements OnInit {
  ...
  TableData = [
    ...
    { header: 'Account Code', hide: false, mandatory: true, width: '8rem', data: '12345678912345', manual: true, PopUp: true, PopUpData: 'DetailAccountFirstCode', bind: "Alld_AccSecond_Code", routeTo: "account-master", type: 'text' },
    ...
    { header: 'Reference', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: "Alld_Reference", type: 'text', PopUp: true, PopUpData: 'InterCoCode' },
    ...
    { header: 'Tax Reference', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: "Alld_Tax_Reference", type: 'text' },
  ...
  TblHDetAccru: any[] = [new TblTransDetailDto()];


  MonthlyEntryTableData = [
    { header: 'Sys ID', hide: false, mandatory: true, width: '3rem', data: '1', manual: false, bind: 'Alld_SysID', type: 'text' },
    { header: 'Accumulated Dep Account SysID', hide: false, mandatory: true, width: '6rem', data: 'A001', manual: false, bind: 'Alld_AccFirst_SysID', type: 'text' },
    { header: 'Accumulated Dep Account Code', hide: false, mandatory: true, width: '10rem', data: 'AC001', manual: true, bind: 'Alld_AccFirst_Code', type: 'text', PopUp: true, PopUpData: 'AccuralAccountFirstCode' },
    { header: 'Accumulated Dep Account Name', hide: false, mandatory: false, width: '12rem', data: 'Cleaning', manual: false, bind: 'Alld_AccFirst_Name', type: 'text' },
    { header: 'Expenses Account SysID', hide: false, mandatory: false, width: '6rem', data: 'E001', manual: false, bind: 'Alld_AccSecond_SysID', type: 'text' },
    { header: 'Expenses Account Code', hide: false, mandatory: false, width: '10rem', data: 'EXP-101', manual: false, bind: 'Alld_AccSecond_Code', type: 'text', PopUp: true, PopUpData: 'AccuralAccountFirstCode2' },
    { header: 'Expenses Account Name', hide: false, mandatory: false, width: '12rem', data: 'Office Supplies', manual: false, bind: 'Alld_AccSecond_Name', type: 'text' },
    { header: 'Schedule Date', hide: false, mandatory: false, width: '10rem', data: '2025-03-25', manual: false, bind: 'Alld_Accr_Date', type: 'date' },
    { header: 'Expenses Amount Without Tax', hide: false, mandatory: false, width: '10rem', data: '500', manual: false, bind: 'Alld_AccrExp_Amount', type: 'number' },
    { header: 'Accumulated Dep Voucher JV SysID', hide: false, mandatory: false, width: '6rem', data: 'JVS001', manual: false, bind: 'Allh_VouJvType_SysID', type: 'text' },
    { header: 'Accumulated Dep Voucher JV Type', hide: false, mandatory: false, width: '8rem', data: 'Standard', manual: false, bind: 'Allh_VouJvType', type: 'text' },
    { header: 'Accumulated Dep JV Number', hide: false, mandatory: false, width: '10rem', data: 'JV1001', manual: false, bind: 'Alld_AccrJv_Number', type: 'text' },
    { header: 'Remark SysID', hide: false, mandatory: false, width: '6rem', data: 'R001', manual: false, bind: "Alld_Remark_SysID", type: 'text', },
    { header: 'Remarks Code', hide: false, mandatory: false, width: '10rem', data: '123456789', manual: false, bind: "Alld_Remark_Code", type: 'text', PopUp: true, PopUpData: 'AccuralRemarksCode' },
    { header: 'Remarks Name', hide: false, mandatory: false, width: '12rem', data: '123456789', manual: false, bind: "Alld_Remark_Name", type: 'text', },
  ...
  hideOrDisplayFields = [
    ...
    },
    {
      ...
      HFieldMaster_Code: '',
      HFieldMaster_Name: '',
      HDataField_Name: 'Allh_fixAss_Code',
      HFieldValue_Yn: false,
      HFieldHide_Yn: false,
      HFieldDisable_Yn: false,
      HField_Alert_Code: 'ALRT002',
    ...
    },
    {
      ...
      HFieldMaster_Code: '',
      HFieldMaster_Name: '',
      HDataField_Name: 'Allh_fixAss_Name',
      HFieldValue_Yn: false,
      HFieldHide_Yn: false,
      HFieldDisable_Yn: false,
      HField_Alert_Code: 'ALRT002',
    ...
    },
    {
      ...
      HFieldMaster_Code: '',
      HFieldMaster_Name: '',
      HDataField_Name: 'Allh_fixAss_Months',
      HFieldValue_Yn: false,
      HFieldHide_Yn: false,
      HFieldDisable_Yn: false,
      HField_Alert_Code: 'ALRT002',
  ...
  selectedItem(event: any) {
    ...
    switch (Type) {
      ...
      case 'FixAssetsCode':
        this.ReceiptPaymentService.receiptPaymentData.tblSecTransHead.Allh_FixAss_Code = event.code
        this.ReceiptPaymentService.receiptPaymentData.tblSecTransHead.Allh_FixAss_Name = event.name
        break;
...
//
      ...
      case 'AccrualMaster':
        this.ReceiptPaymentService.receiptPaymentData.tblTransHead.Allh_Accr_Code = event.HAccru_Code
        this.ReceiptPaymentService.receiptPaymentData.tblTransHead.Allh_Accr_Name = event.HAccru_Name
        // this.ReceiptPaymentService.receiptPaymentData.voucherSysId = event.sysId
        break;


      case 'AccuralAccountFirstCode':
        this.TblHDetAccru[this.tableIndex].Alld_AccFirst_Code = event.HAccOne_Code
        this.TblHDetAccru[this.tableIndex].Alld_AccFirst_Name = event.HAccOne_Name
        break;
      case 'AccuralAccountFirstCode2':
        this.TblHDetAccru[this.tableIndex].Alld_AccSecond_Code = event.HAccOne_Code
        this.TblHDetAccru[this.tableIndex].Alld_AccSecond_Name = event.HAccOne_Name
        break;
      case 'AccuralRemarksCode':
        this.TblHDetAccru[this.tableIndex].Alld_Remark_Code = event.HRemMast_Code
        this.TblHDetAccru[this.tableIndex].Alld_Remark_Name = event.HRemMast_Name
        break;

      case 'DetailAccountFirstCode':
        this.ReceiptPaymentService.receiptPaymentData.tblTransDetail[this.tableIndex].Alld_AccSecond_Code = event.HAccOne_Code
        this.ReceiptPaymentService.receiptPaymentData.tblTransDetail[this.tableIndex].Alld_AccSecond_Name = event.HAccOne_Name
        break;
...
//
  ...
  deleteRow(table: any, index: number) {
    ...
    if (table == 'TblHDetAccru') {
      this.TblHDetAccru.splice(index, 1);
    }
  }
