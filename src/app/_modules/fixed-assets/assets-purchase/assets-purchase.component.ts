...
@Component({
  selector: 'app-assets-purchase',
  templateUrl: './assets-purchase.component.html',
  styleUrls: ['./assets-purchase.component.scss']
})
...
ReferenceAllocationData = {
  ...
  TableData = [
    { field: 'sysId', header: 'Sys ID', hide: false, mandatory: true, width: '3rem', data: '12345678912345', manual: false },
    { field: 'serialNo', header: 'S. No', hide: false, mandatory: true, width: '8rem', data: '12345678912345', manual: false },
    { field: 'assetsAccountCode', header: 'Assets Account Code', hide: false, mandatory: true, width: '8rem', data: '12345678912345', manual: true, PopUp: true, PopUpData: 'AssetsAccountCode' },
    { field: 'assetsAccountName', header: 'Assets Account Name', hide: false, mandatory: true, width: '16rem', data: '123456789123456789123456789', manual: false },
    { field: 'assetsCode', header: 'Assets Code', hide: false, mandatory: true, width: '8rem', data: '12345678912345', manual: true, PopUp: true, PopUpData: 'AssetsAccountCode' },
    { field: 'assetsName', header: 'Assets Name', hide: false, mandatory: true, width: '16rem', data: '123456789123456789123456789', manual: false },
    { field: 'batchNumber', header: 'Batch Number', hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: true },
    { field: 'unit', header: 'Unit', hide: false, mandatory: true, width: '8rem', data: '12345678912345', manual: false },
    { field: 'numberOfAssets', header: 'Number of Assets', hide: false, mandatory: true, width: '8rem', data: '12345678912345', manual: true },
    ...
    { field: 'nextDepreciationDate', header: 'Next Depreciation Date', hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: true },
    { field: 'warehouseCode', header: 'Warehouse Code', hide: false, mandatory: true, width: '8rem', data: '12345678912345', manual: true },
    { field: 'warehouseName', header: 'Warehouse Name', hide: false, mandatory: true, width: '16rem', data: '123456789123456789123456789', manual: false },
...
SubMainTabData = [
    {
        ...
        accumulatedDepreciationAmount: '1000',
        depreciationExpensesAmount: '200',
        listFixedAssetsJV: true
    },
    {
        categorySysID: '002',
        accountCode: 'B456',
        ...
        accumulatedDepreciationAmount: '1500',
        depreciationExpensesAmount: '300',
        listFixedAssetsJV: false
    },
];
