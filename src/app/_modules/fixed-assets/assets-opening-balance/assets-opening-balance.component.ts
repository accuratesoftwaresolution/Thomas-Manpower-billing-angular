...
@Component({
  selector: 'app-assets-opening-balance',
  templateUrl: './assets-opening-balance.component.html',
  styleUrls: ['./assets-opening-balance.component.scss']
})
export class AssetsOpeningBalanceComponent implements OnInit {
