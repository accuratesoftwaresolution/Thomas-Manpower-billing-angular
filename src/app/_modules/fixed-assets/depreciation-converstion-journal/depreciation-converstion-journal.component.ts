...
@Component({
  selector: 'app-depreciation-converstion-journal',
  templateUrl: './depreciation-converstion-journal.component.html',
  styleUrls: ['./depreciation-converstion-journal.component.scss']
})
export class DepreciationConverstionJournalComponent implements OnInit {
