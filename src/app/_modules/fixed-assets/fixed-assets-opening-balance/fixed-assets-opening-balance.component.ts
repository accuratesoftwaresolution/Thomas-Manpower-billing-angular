...
@Component({
  selector: 'app-fixed-assets-opening-balance',
  templateUrl: './fixed-assets-opening-balance.component.html',
  styleUrls: ['./fixed-assets-opening-balance.component.scss']
})
export class FixedAssetsOpeningBalanceComponent implements OnInit {
