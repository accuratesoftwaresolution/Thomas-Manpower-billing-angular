...
@Component({
  selector: 'app-fixed-assets-purchase',
  templateUrl: './fixed-assets-purchase.component.html',
  styleUrls: ['./fixed-assets-purchase.component.scss']
})
export class FixedAssetsPurchaseComponent implements OnInit {
