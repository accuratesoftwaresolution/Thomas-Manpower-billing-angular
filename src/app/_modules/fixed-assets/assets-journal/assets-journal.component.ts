...
@Component({
  selector: 'app-assets-journal',
  templateUrl: './assets-journal.component.html',
  styleUrls: ['./assets-journal.component.scss']
})
export class AssetsJournalComponent implements OnInit {
