...
@Component({
  selector: 'app-service-purch',
  templateUrl: './service-purch.component.html',
  styleUrls: ['./service-purch.component.scss']
})
export class ServicePurchComponent implements OnInit {
