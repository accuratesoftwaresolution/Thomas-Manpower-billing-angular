...
@Component({
  selector: 'app-inter-co-service-purchase-order',
  templateUrl: './inter-co-service-purchase-order.component.html',
  styleUrls: ['./inter-co-service-purchase-order.component.scss']
})
export class InterCoServicePurchaseOrderComponent implements OnInit {
