...
@Component({
  selector: 'app-inter-co-credit-note-request',
  templateUrl: './inter-co-credit-note-request.component.html',
  styleUrls: ['./inter-co-credit-note-request.component.scss']
})
export class InterCoCreditNoteRequestComponent implements OnInit {
