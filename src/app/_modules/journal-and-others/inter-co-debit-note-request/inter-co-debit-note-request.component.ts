...
@Component({
  selector: 'app-inter-co-debit-note-request',
  templateUrl: './inter-co-debit-note-request.component.html',
  styleUrls: ['./inter-co-debit-note-request.component.scss']
})
export class InterCoDebitNoteRequestComponent implements OnInit {
