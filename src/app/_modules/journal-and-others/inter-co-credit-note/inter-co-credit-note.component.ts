...
@Component({
  selector: 'app-inter-co-credit-note',
  templateUrl: './inter-co-credit-note.component.html',
  styleUrls: ['./inter-co-credit-note.component.scss']
})
export class InterCoCreditNoteComponent implements OnInit {
