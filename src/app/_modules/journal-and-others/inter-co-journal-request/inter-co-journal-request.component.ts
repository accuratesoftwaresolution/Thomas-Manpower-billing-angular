...
@Component({
  selector: 'app-inter-co-journal-request',
  templateUrl: './inter-co-journal-request.component.html',
  styleUrls: ['./inter-co-journal-request.component.scss']
})
export class InterCoJournalRequestComponent implements OnInit {
