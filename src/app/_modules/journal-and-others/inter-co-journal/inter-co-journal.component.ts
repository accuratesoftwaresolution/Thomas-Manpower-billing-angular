...
@Component({
  selector: 'app-inter-co-journal',
  templateUrl: './inter-co-journal.component.html',
  styleUrls: ['./inter-co-journal.component.scss']
})
export class InterCoJournalComponent implements OnInit {
