...
@Component({
  selector: 'app-inter-co-debit-note',
  templateUrl: './inter-co-debit-note.component.html',
  styleUrls: ['./inter-co-debit-note.component.scss']
})
export class InterCoDebitNoteComponent implements OnInit {
