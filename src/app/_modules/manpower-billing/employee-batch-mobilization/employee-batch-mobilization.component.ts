...
@Component({
  selector: 'app-employee-batch-mobilization',
  templateUrl: './employee-batch-mobilization.component.html',
  styleUrls: ['./employee-batch-mobilization.component.scss']
})
export class EmployeeBatchMobilizationComponent implements OnInit {
  ...
  TableData = [
    { header: 'Employee Grid SysID', bind: 'Alld_SysID', width: '8rem', type: 'text', readOnly: true, hide: true, mandatory: true },
    ...
    { header: 'Employee Name', bind: 'Alld_ProdShort_Name', width: '14rem', type: 'text' },


    { header: 'Employee Module SysID', bind: 'Alld_EmplModu_SysID', width: '8rem', type: 'text', readOnly: true, hide: true },
    { header: 'Employee Module Code', bind: 'Alld_EmplModu_Code', width: '12rem', type: 'text', PopUpData: 'Employee' },
    { header: 'Employee  Module Name', bind: 'Alld_EmplModu_Name', width: '14rem', type: 'text' },


    { header: 'Job SysID', bind: 'Alld_Job_SysID', width: '8rem', type: 'text', readOnly: true, hide: true },
    { header: 'Job Code', bind: 'Alld_Job_Code', width: '12rem', type: 'text', PopUpData: 'Employee' },
    { header: 'Job Name', bind: 'Alld_Job_Name', width: '14rem', type: 'text' },


    { header: 'MRV Batch SysID', bind: 'Alld_MRVBatch_SysID', width: '8rem', type: 'text', readOnly: true, hide: true },
    { header: 'MRV Batch Code', bind: 'Alld_MRVBatch_Code', width: '12rem', type: 'text', PopUpData: 'Employee' },
    { header: 'MRV Batch Name', bind: 'Alld_MRVBatch_Name', width: '14rem', type: 'text' },
    ...
    { header: 'Link Voucher No. 01', bind: 'Alld_Link_One', width: '10rem', type: 'text', hide: true },
    { header: 'Link Voucher No. 02', bind: 'Alld_Link_Two', width: '10rem', type: 'text', },
    { header: 'Link Voucher No. 03', bind: 'Alld_Link_Three', width: '10rem', type: 'text' },
  ...
  CriteriaTableData = [
    { header: 'Criteria List Grid SysID', bind: 'Alld_CritGridNo', type: 'number', hide: true, mandatory: true, width: '6rem', data: '', manual: false },
    
    { header: 'Criteria List SysID', bind: 'Alld_CritSysID', type: 'number', hide: true, mandatory: false, width: '6rem', data: '', manual: false },
    { header: 'Criteria List Code', bind: 'Alld_CritCode', type: 'text', hide: false, mandatory: false, width: '8rem', data: '', manual: false, PopUp: true, PopUpData: 'Alld_CritCode' },
    { header: 'Criteria List Name', bind: 'Alld_CritName', type: 'text', hide: false, mandatory: false, width: '10rem', data: '', manual: false },
    
    { header: 'Values', bind: 'Alld_CritReqYn', type: 'text', hide: false, mandatory: false, width: '10rem', data: '', manual: false },
    { header: 'Select All', bind: 'Alld_CritSelect', type: 'number', hide: false, mandatory: false, width: '6rem', data: '', manual: false, affects: [], readOnly: null, routeTo: "" },
    
    { header: 'Remarks SysID', bind: 'Alld_CritRem_SysID', type: 'number', hide: true, mandatory: false, width: '6rem', data: '', manual: false },
    { header: 'Remarks Code', bind: 'Alld_CritRem_Code', type: 'text', hide: false, mandatory: false, width: '8rem', data: '', manual: false, PopUp: true, PopUpData: 'RemarksCode' },
    { header: 'Remarks Name', bind: 'Alld_CritRem_Name', type: 'text', hide: false, mandatory: false, width: '10rem', data: '', manual: false }
  ];
