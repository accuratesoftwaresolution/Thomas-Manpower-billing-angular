...
@Component({
  selector: 'app-company-vise-visaquota-additionaldetails',
  templateUrl: './company-vise-visaquota-additionaldetails.component.html',
  styleUrls: ['./company-vise-visaquota-additionaldetails.component.scss']
})
export class CompanyViseVisaquotaAdditionaldetailsComponent implements OnInit {
  ...
  TableData = [
    ...
    //{ field: 'Visa Quota Grid SysID', header: 'Visa Quota Grid SysID', hide: true, mandatory: false, width: '3rem', data: "12345", manual: false, bind: "Alld_SysID", type: 'text' },
    //{ field: 'Project Company SysID', header: 'Project Company SysID', hide: true, mandatory: true, width: '8rem', data: '12345678912345', manual: true, PopUp: true, PopUpData: 'ProductCode', bind: "Alld_ProjCompany_SysID", routeTo: "product-master", type: 'text' },
    { field: 'Project Company Code', header: 'Project Company Code', hide: false, mandatory: false, width: '10rem', data: '123456789123456789123456789', manual: false, bind: "Alld_ProjCompany_Code",Popup:true,PopUpData: 'ProductCode', type: 'text' },
    { field: 'Project Company Name', header: 'Project Company Name', hide: false, mandatory: false, width: '15rem', data: '123456789123456789123456789', manual: false, bind: "Alld_ProjCompany_Name", type: 'text' },
    //{ field: 'Visa Quota  Designation SysID', header: 'Visa Quota  Designation SysID', hide: true, mandatory: false, width: '4rem', data: '123456', manual: true, bind: "Alld_VisaQDesig_SysID", affects: ['Alld_Gross_Amount', 'Alld_Net_Amount'], align: 'left', type: 'number' },
    { field: 'Visa Quota  Designation Code', header: 'Visa Quota  Designation Code', hide: false, mandatory: false, width: '10rem', data: '12345678912345', manual: false, bind: "Alld_VisaQDesig_Code",  align: 'left', type: 'text' ,Popup:true,PopUpData:'visadesignationcode'},
    { field: 'Visa Quota  Designation Name', header: 'Visa Quota  Designation Name', hide: false, mandatory: false, width: '15rem', data: '12345678912345', manual: false, bind: "Alld_VisaQDesig_Name", affects: ['Alld_Gross_Amount', 'Alld_Net_Amount'], align: 'left', type: 'text' },
    { field: 'Quota Number', header: 'Quota Number', hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: false, bind: "Alld_Prod_Qty", readOnly: true, align: 'left', type: 'number' },
