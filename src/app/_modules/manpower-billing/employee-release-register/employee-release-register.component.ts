...
@Component({
  selector: 'app-employee-release-register',
  templateUrl: './employee-release-register.component.html',
  styleUrls: ['./employee-release-register.component.scss']
})
export class EmployeeReleaseRegisterComponent implements OnInit {
