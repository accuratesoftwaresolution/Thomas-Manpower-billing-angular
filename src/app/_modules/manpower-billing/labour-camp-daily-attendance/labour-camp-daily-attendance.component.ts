...
@Component({
  selector: 'app-labour-camp-daily-attendance',
  templateUrl: './labour-camp-daily-attendance.component.html',
  styleUrls: ['./labour-camp-daily-attendance.component.scss']
})
export class LabourCampDailyAttendanceComponent implements OnInit {
  ...
  TableData = [
    { header: 'Grid SysID', bind: 'Alld_SysID', width: '6rem', type: 'text', readOnly: true, hide: 'true' },
    ...
    { header: 'Job SysID', bind: 'Alld_Job_SysID', width: '8rem', type: 'text', readOnly: false, hide: true },
    { header: 'Job Code', bind: 'Alld_Job_Code', width: '10rem', type: 'text', readOnly: false, PopUpData: 'EmployeeModule' },
    { header: 'Job Name', bind: 'Alld_Job_Name', width: '15rem', type: 'text', readOnly: false },


    { header: 'Designation SysID', bind: 'Alld_Desig_SysID', width: '8rem', type: 'text', readOnly: false, hide: true },
    { header: 'Designation Code', bind: 'Alld_Desig_Code', width: '10rem', type: 'text', readOnly: false, PopUpData: 'EmployeeModule' },
    { header: 'Designation Name', bind: 'Alld_Desig_Name', width: '15rem', type: 'text', readOnly: false },


    { header: 'Customer Site SysID', bind: 'Alld_Site_SysID', width: '8rem', type: 'text', readOnly: false, hide: true },
    { header: 'Customer Site Code', bind: 'Alld_Site_Code', width: '10rem', type: 'text', readOnly: false, PopUpData: 'EmployeeModule' },
    { header: 'Customer Site Name', bind: 'Alld_Site_Name', width: '15rem', type: 'text', readOnly: false },

    { header: 'Date', bind: 'Alld_Proj_Date', width: '8rem', type: 'date', readOnly: false },
    { header: 'Month', bind: 'Alld_ProjMonth', width: '8rem', type: 'date', readOnly: false },

    { header: 'Year', bind: 'Alld_ProjYear', width: '8rem', type: 'date', readOnly: false },
    { header: 'Attendance', bind: 'Alld_Empl_Atten', width: '10rem', type: 'text', readOnly: false },

    { header: 'Leave Type SysID', bind: 'ld_Ltype_SysID', width: '8rem', type: 'text', readOnly: false, hide: true },
    { header: 'Leave Type Code', bind: 'ld_Ltype_Code', width: '10rem', type: 'text', readOnly: false, PopUpData: 'EmployeeModule' },
    { header: 'Leave Type Name', bind: 'ld_Ltype_Name', width: '15rem', type: 'text', readOnly: false },
    { header: 'Leave Type Short Name', bind: 'Alld_LShort_Name', width: '15rem', type: 'text', readOnly: false },


    { header: 'Remarks SysID', bind: 'Alld_Remark_SysID', type: 'text', hide: true, width: '8rem', align: 'left', mandatory: 'true' },
    { header: 'Remarks Code', bind: 'Alld_Remark_Code', type: 'text', hide: false, width: '10rem', align: 'left', Popup: true, PopUpData: 'ClientCode' },
    { header: 'Remarks Name', bind: 'Alld_Remark_Name', type: 'text', hide: false, width: '15rem', align: 'left' },
