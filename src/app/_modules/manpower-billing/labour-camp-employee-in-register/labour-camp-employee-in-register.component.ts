...
@Component({
  selector: 'app-labour-camp-employee-in-register',
  templateUrl: './labour-camp-employee-in-register.component.html',
  styleUrls: ['./labour-camp-employee-in-register.component.scss']
})
export class LabourCampEmployeeInRegisterComponent implements OnInit {
