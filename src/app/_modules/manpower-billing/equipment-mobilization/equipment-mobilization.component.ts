...
@Component({
  selector: 'app-equipment-mobilization',
  templateUrl: './equipment-mobilization.component.html',
  styleUrls: ['./equipment-mobilization.component.scss']
})
export class EquipmentMobilizationComponent implements OnInit {
