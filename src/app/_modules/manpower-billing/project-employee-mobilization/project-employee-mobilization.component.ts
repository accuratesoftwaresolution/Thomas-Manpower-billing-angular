...
@Component({
  selector: 'app-project-employee-mobilization',
  templateUrl: './project-employee-mobilization.component.html',
  styleUrls: ['./project-employee-mobilization.component.scss']
})
export class ProjectEmployeeMobilizationComponent implements OnInit {
  TransactionSteps = [
