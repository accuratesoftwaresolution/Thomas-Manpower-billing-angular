...
@Component({
  selector: 'app-company-level-visaquota-deletion-details',
  templateUrl: './company-level-visaquota-deletion-details.component.html',
  styleUrls: ['./company-level-visaquota-deletion-details.component.scss']
})
export class CompanyLevelVisaquotaDeletionDetailsComponent implements OnInit {
