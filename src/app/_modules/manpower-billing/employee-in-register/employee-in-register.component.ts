...
@Component({
  selector: 'app-employee-in-register',
  templateUrl: './employee-in-register.component.html',
  styleUrls: ['./employee-in-register.component.scss']
})
export class EmployeeInRegisterComponent implements OnInit {
  ...
  TableData = [
    { field: 'Alld_SysID', header: 'Grid SysID', bind: 'Alld_SysID', width: '6rem', type: 'text', readOnly: true, hide: 'true' },
    { field: 'Alld_EmpSysID', header: 'Employee SysID', bind: 'Alld_Prod_SysID', width: '6rem', type: 'text', readOnly: false, hide: "true" },
    { field: 'Alld_EmpCode', header: 'Employee Code', bind: 'Alld_Prod_Code', width: '10rem', type: 'text', readOnly: false, PopUpData: 'Employee' },
    { field: 'Alld_EmpName', header: 'Employee Name', bind: 'Alld_ProdShort_Name', width: '15rem', type: 'text', readOnly: false },

    { field: 'Alld_EmpModl_SysID', header: 'Employees Module SysID', bind: 'Alld_EmplModu_SysID', width: '8rem', type: 'text', readOnly: false, hide: true },
    { field: 'Alld_EmpModl_Code', header: 'Employees Module Code', bind: 'Alld_EmplModu_Code', width: '10rem', type: 'text', readOnly: false, PopUpData: 'EmployeeModule' },
    { field: 'Alld_EmplModu_Name', header: 'Employees Module Name', bind: 'Alld_EmplModu_Name', width: '15rem', type: 'text', readOnly: false },

    { field: 'Alld_ProjCompanySysID', header: 'Location SysID', bind: 'Alld_FromLocation_SysID', width: '6rem', type: 'text', readOnly: true, hide: true },
    { field: 'Alld_ProjCompany_Code', header: 'Location Code', bind: 'Alld_FromLocation_Code', width: '10rem', type: 'text', readOnly: false, PopUpData: 'projectCompany' },
    { field: 'Alld_FromLocation_Name', header: 'Location Name', bind: 'Alld_FromLocation_Name', width: '15rem', type: 'text', readOnly: false },

    { field: 'Alld_ProdUnit_SysID', header: 'Unit SysID', bind: 'Alld_ProdUnit_SysID', width: '6rem', type: 'text', readOnly: false, hide: true },
    { field: 'Alld_ProdUnit_Code', header: 'Unit Code', bind: 'Alld_ProdUnit_Code', width: '10rem', type: 'text', readOnly: false, PopUpData: 'Unit' },
    { field: 'Alld_Prod_Unit', header: 'Unit Name', bind: 'Alld_Prod_Unit', width: '15rem', type: 'text', readOnly: false },

    { field: 'Alld_Prod_Qty', header: 'Number of Employee', bind: 'Alld_Prod_Qty', width: '8rem', type: 'text', readOnly: false, hide: true },
    { field: 'Alld_Prod_Rate', header: 'Manpower Rate ', bind: 'Alld_Prod_Rate', width: '8rem', type: 'text', readOnly: false },
    { field: 'Alld_Link_One', header: 'Link Voucher No. 01', bind: 'Alld_Link_One', width: '8rem', type: 'text', readOnly: false },
