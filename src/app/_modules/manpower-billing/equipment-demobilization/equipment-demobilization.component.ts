...
@Component({
  selector: 'app-equipment-demobilization',
  templateUrl: './equipment-demobilization.component.html',
  styleUrls: ['./equipment-demobilization.component.scss']
})
export class EquipmentDemobilizationComponent implements OnInit {
  ...
  TableData = [
    { header: 'Equipment HGrid SysID', bind: 'Alld_SysID', width: '8rem', type: 'text', readOnly: true, hide: true, mandatory: true },

    { header: 'Equipment Type SysID', bind: 'Alld_EqupType_SysID', width: '8rem', type: 'text', readOnly: true, hide: true },
    { header: 'Equipment Type Code', bind: 'Alld_EqupType_Code', width: '12rem', type: 'text', PopUpData: 'Designation' },
    { header: 'Equipment Type  Name ', bind: 'Alld_EqupType_Name', width: '14rem', type: 'text' },


    { header: 'Equipment SysID', bind: 'Alld_EqupType_Name', width: '8rem', type: 'text', readOnly: true, hide: true },
    { header: 'Equipment  Code', bind: 'Alld_Equp_Code', width: '12rem', type: 'text', PopUpData: 'Employee' },
    { header: 'Equipment   Name', bind: 'Alld_Equp_Name', width: '14rem', type: 'text' },
    { header: 'Equipment Plate Number', bind: 'Alld_Equp_PlateNo', width: '14rem', type: 'text' },


    { header: 'From Location SysID', bind: 'Alld_FromLocation_SysID', width: '8rem', type: 'text', readOnly: true, hide: true },
    { header: 'From Location Code', bind: 'Alld_FromLocation_Code', width: '12rem', type: 'text', PopUpData: 'Employee' },
    { header: 'From Location Name', bind: 'Alld_FromLocation_Name', width: '14rem', type: 'text' },


    { header: 'To Location SysID', bind: 'Alld_ToLocation_SysID', width: '8rem', type: 'text', readOnly: true, hide: true },
    { header: 'To Location Code', bind: 'Alld_ToLocation_Code', width: '12rem', type: 'text', PopUpData: 'Employee' },
    { header: 'To Location Name', bind: 'Alld_ToLocation_Name', width: '14rem', type: 'text' },

    { header: 'Unit SysID', bind: 'Alld_ProdUnit_SysID', width: '8rem', type: 'text', hide: true },
    { header: 'Unit Code', bind: 'Alld_ProdUnit_Code', width: '10rem', type: 'text', },
    { header: 'Unit Name', bind: 'Alld_Prod_Unit', width: '14rem', type: 'text' },

    { header: 'Number of Vehicle', bind: 'Alld_Prod_Qty', width: '10rem', type: 'number' },

    { header: 'Unit Cost Rate/Hours', bind: 'Alld_Prod_Rate', width: '10rem', type: 'number' },
    { header: 'Amount', bind: 'Alld_Gross_Amount', width: '10rem', type: 'number' },

    { header: 'Year of Purchase', bind: 'Alld_AssetPurch_Year', width: '10rem', type: 'number' },

    { header: 'Number of Years Used', bind: 'Alld_AssetYear_Used', width: '10rem', type: 'number' },
    { header: 'Total  Life od Vehicle ', bind: 'Alld_AssetTotal_Life', width: '10rem', type: 'number' },

    { header: 'Expected to Sell Date', bind: 'Alld_AssetExp_SellDate', width: '10rem', type: 'number' },


    { header: 'Currency SysID', bind: 'Alld_Curr_SysID', width: '8rem', type: 'text', hide: true },
    { header: 'Currency Code', bind: 'Alld_Curr_Code', width: '10rem', type: 'text', PopUpData: 'ClientCode' },
    { header: 'Currency Name', bind: 'Alld_Curr_Name', width: '14rem', type: 'text' },
    { header: 'Conversion Rate', bind: 'Alld_Curr_Rate', width: '14rem', type: 'text' },


    { header: 'Remarks SysID', bind: 'Alld_Remark_SysID', width: '8rem', type: 'text', hide: true },
    { header: 'Remarks Code', bind: 'Alld_Remark_Code', width: '10rem', type: 'text', PopUpData: 'ClientCode' },
    { header: 'Remarks Name', bind: 'Alld_Remark_Name', width: '14rem', type: 'text' }
  ];

  CriteriaTable = [
    { header: 'Criteria Grid SysID', bind: 'Alld_CritGridNo', width: '8rem', type: 'text', readOnly: true, hide: true, mandatory: true },

    { header: 'Criteria SysID', bind: 'Alld_CritSysID', width: '8rem', type: 'text', readOnly: true, hide: true },
    { header: 'Criteria Code', bind: 'Alld_CritCode', width: '12rem', type: 'text', PopUpData: 'Employee' },
    { header: 'Criteria Name', bind: 'Alld_CritName', width: '14rem', type: 'text' },


    { header: 'Required Y/N', bind: 'Alld_CritReqYn', width: '8rem', type: 'text', readOnly: true, hide: false },

    { header: 'Select All', bind: 'Alld_CritSelect', width: '12rem', type: 'text', },

    { header: 'Remarks SysID', bind: 'Alld_CritRem_SysID', width: '8rem', type: 'text', hide: true },
    { header: 'Remarks Code', bind: 'Alld_CritRem_Code', width: '10rem', type: 'text', PopUpData: 'RemarksCode' },
    { header: 'Remarks Name', bind: 'Alld_CritRem_Name', width: '14rem', type: 'text' }
