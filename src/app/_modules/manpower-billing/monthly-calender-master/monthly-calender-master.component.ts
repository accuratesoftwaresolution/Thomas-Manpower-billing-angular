...
@Component({
  selector: 'app-monthly-calender-master',
  templateUrl: './monthly-calender-master.component.html',
  styleUrls: ['./monthly-calender-master.component.scss']
})
export class MonthlyCalenderMasterComponent implements OnInit {
  ...
  monthdata = {
    Allh_ProjMonth: null,
    TblProjTransDetail: [
      { selected: false, Alld_McalDay: null, Alld_McalDayInWord: '', Alld_McalWoking: '', Alld_McalSunday: '', Alld_McalPubHoliday: '', Alld_McalSummary: '', Alld_Remark_SysID: null, Alld_Remark_Code: '', Alld_Remark_Name: '', Alld_Grid_SysID: null }
    ]
  };
  ...
  scrollableTabs: any[] = [
    ...
    { id: 1, title: "Client Contact Details", content: "", visible: false },
    { id: 2, title: "Our Site Contact Details", content: "", visible: false },
    { id: 3, title: "Criteria Checking", content: "", visible: false },

    { id: 4, title: "Payment Terms", content: "", visible: true }, // Hidden tab example
    { id: 5, title: "PO Number", content: "", visible: true },
    { id: 6, title: "Tax", content: "Content for Tax", visible: true },
    { id: 7, title: "Masters", content: "Content for Masters", visible: true },
    { id: 8, title: "Other Fields", content: "Content for Other Fields", visible: true },
    { id: 9, title: "User Key", content: "Content for User Key", visible: true },
    { id: 10, title: "Document Attachment", content: "Content for Document Attachment", visible: true },
  ];
  ...
  TableData = [
    { header: 'Calender Grid SysID', hide: true, mandatory: true, width: '6rem', data: '', manual: false, bind: 'Alld_SysID', type: 'number' },
    { header: 'Days', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_McalDay', type: 'number' },
    { header: 'Days in Word', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_McalDayInWord', type: 'text' },
    { header: 'Working', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_McalWoking', type: 'text' },

    { header: 'Sundays', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_McalSunday', type: 'text' },

    { header: 'Public Holidays', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_McalPubHoliday', type: 'text', affects: [], readOnly: null, routeTo: "" },
    { header: 'Summary', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_McalSummary', type: 'text', },
  ...
  ClientTableData = [
    ...
    { header: 'Designation Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, PopUp: true, PopUpData: 'AlldClie_Desig_Code', bind: 'Alld_ClieDesig_Code', type: 'text' },
    ...
    { header: 'Remarks Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_ClieRemark_SysID', type: 'text', PopUp: true, PopUpData: 'RemarksCode' },
   ...
   SiteTableData = [
    ...
    { header: 'Designation Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, PopUp: true, PopUpData: 'Alld_OurDesig_Code', bind: 'Alld_OurDesig_Code', type: 'text' },
  ...
  Save() {
    ...
    console.log("saved the data:::::::", this.transactionhead)
  ...
  addRow(table: any, index: number) {
    ...
    if (table == 'TblProjTransDetail') {
      const newRow = new TblProjTransDetail()
      this.transactionhead.TblProjTransDetail.splice(index + 1, 0, newRow);
    }
  ...
  onMonthOrYearChange() {
    ...
    const year: number = Number(this.transactionhead.Allh_ProjYear);
    const month: number = Number(this.transactionhead.Allh_ProjMonth);
    ...
    this.transactionhead.TblProjTransDetail = [];
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      this.transactionhead.TblProjTransDetail.push({
        Alld_McalDay: day,
        Alld_McalDayInWord: dayName,
        Alld_McalWoking: '',
  ...
  onDayTypeChange(rowData: TblProjTransDetail) {
    switch (rowData.Alld_McalDayType) {
      case 'W':
        rowData.Alld_McalSummary = 'P';
        break;
      case 'S':
        rowData.Alld_McalSummary = 'H';
        break;
      case 'H':
        rowData.Alld_McalSummary = 'HOT';
        break;
      default:
        rowData.Alld_McalSummary = '';
    }
  }
