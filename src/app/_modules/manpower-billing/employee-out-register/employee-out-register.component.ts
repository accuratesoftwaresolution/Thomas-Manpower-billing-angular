...
@Component({
  selector: 'app-employee-out-register',
  templateUrl: './employee-out-register.component.html',
  styleUrls: ['./employee-out-register.component.scss']
})
export class EmployeeOutRegisterComponent implements OnInit {
  ...
  TableData = [
    ...
    { header: 'Employees Module SysID', bind: 'Alld_EmplModu_SysID', width: '8rem', type: 'text', hide: true },
    { header: 'Employees Module Code', bind: 'Alld_EmplModu_Code', width: '12rem', type: 'text', PopUpData: 'EmployeeModule' },
    { header: 'Employees Module Name', bind: 'Alld_EmplModu_Name', width: '14rem', type: 'text' },

    { header: 'Job SysID', bind: 'Alld_Job_SysID', width: '8rem', type: 'text', hide: true },
    { header: 'Job Code', bind: 'Alld_Job_Code', width: '10rem', type: 'text' },
    { header: 'Job Name', bind: 'Alld_Job_Name', width: '14rem', type: 'text' },

    { header: 'Location SysID', bind: 'Alld_FromLocation_SysID', width: '8rem', type: 'text', hide: true },
    { header: 'Location Code', bind: 'Alld_FromLocation_Code', width: '10rem', type: 'text', PopUpData: 'projectCompany' },
    { header: 'Location Name', bind: 'Alld_FromLocation_Name', width: '14rem', type: 'text' },

    { header: 'Unit SysID', bind: 'Alld_ProdUnit_SysID', width: '8rem', type: 'text', hide: true },
    { header: 'Unit Code', bind: 'Alld_ProdUnit_Code', width: '10rem', type: 'text', PopUpData: 'Unit' },
    ...
    { header: 'Link Voucher No. 01', bind: 'Alld_Link_One', width: '10rem', type: 'text' },
    ...
    { header: 'Leave Start Date', bind: 'Alld_Lstart_Date', width: '10rem', type: 'date' },
    { header: 'Leave End Date', bind: 'Alld_Lend_Date', width: '10rem', type: 'date' },
