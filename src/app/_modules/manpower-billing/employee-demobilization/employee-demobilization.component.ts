...
@Component({
  selector: 'app-employee-demobilization',
  templateUrl: './employee-demobilization.component.html',
  styleUrls: ['./employee-demobilization.component.scss']
})
export class EmployeeDemobilizationComponent implements OnInit {
  TransactionSteps = [
