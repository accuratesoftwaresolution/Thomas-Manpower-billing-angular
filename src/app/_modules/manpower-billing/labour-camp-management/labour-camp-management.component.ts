...
import { TblHPCampMaster } from 'src/app/_dto/labour-camp-management/TblHPCampMaster.dto';
import { TbldPCampMaster } from 'src/app/_dto/labour-camp-management/TbldPCampMaster.dto';
import { TbldPCampMasterCo } from 'src/app/_dto/labour-camp-management/TbldPCampMasterCo.dto';
@Component({
  selector: 'app-labour-camp-management',
  templateUrl: './labour-camp-management.component.html',
  styleUrls: ['./labour-camp-management.component.scss']
})
export class LabourCampManagementComponent implements OnInit {
  ...
  TblHPCampMaster: TblHPCampMaster = new TblHPCampMaster()
  ...
  TableData = [
    { header: 'Labour Camp Contact Grid', hide: true, mandatory: true, width: '6rem', data: '', manual: false, bind: 'Hpd_CampGridSysID', type: 'number', readOnly: null },

    { header: 'Designation SysID', hide: true, mandatory: false, width: '6rem', data: '', manual: false, bind: 'Hpd_CampDesigSysID', type: 'text', affects: [], readOnly: null, routeTo: "" },
    { header: 'Designation Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Hpd_CampDesigCode', type: 'text', PopUpData: 'AccountFirstCode', },
    { header: 'Designation Name', hide: false, mandatory: false, width: '14rem', data: '', manual: false, bind: 'Hpd_CampDesigName', type: 'text' },

    { header: 'Contact Person Name', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Hpd_CampCont_Person', type: 'text', },
    { header: 'Contact Number', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Hpd_CampCont_Number', type: 'text' },
    { header: 'Mobile Number', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Hpd_CampCont_Mob', type: 'text' },
    { header: 'Email Address', hide: false, mandatory: false, width: '15rem', data: '', manual: false, bind: 'Hpd_CampCont_Email', type: 'number' },

    { header: 'Remarks SysID', hide: true, mandatory: false, width: '6rem', data: '', manual: false, bind: 'Hpd_CampRemark_SysID', type: 'number', },
    { header: 'Remarks Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Hpd_CampRemark_Code', type: 'text', PopUp: true, PopUpData: 'RemarksCode' },
    { header: 'Remarks Name', hide: false, mandatory: false, width: '14rem', data: '', manual: false, bind: 'Hpd_CampRemark_Name', type: 'number' },
  ];
  ...
  ngOnInit(): void {
    this.TblHPCampMaster.TbldPCampMaster.push(new TbldPCampMaster())
    this.TblHPCampMaster.TbldPCampMasterCo.push(new TbldPCampMasterCo())
  ...
  Save() {
    ...
    console.log("saved the data:::::::", this.TblHPCampMaster)
  ...
  addRow(table: any, index: number) {
    ...
    if (table == 'TbldPCampMaster') {
      const newRow = new TbldPCampMaster()
      this.TblHPCampMaster.TbldPCampMaster.splice(index + 1, 0, newRow);
    }
