...
@Component({
  selector: 'app-labour-camp-employee-out-register',
  templateUrl: './labour-camp-employee-out-register.component.html',
  styleUrls: ['./labour-camp-employee-out-register.component.scss']
})
export class LabourCampEmployeeOutRegisterComponent implements OnInit {
  ...
  TableData = [
    ...
    { header: 'Location SysID', bind: 'Alld_FromLocation_SysID', width: '6rem', type: 'text', readOnly: true, hide: true },
    { header: 'Location Code', bind: 'Alld_FromLocation_Code', width: '10rem', type: 'text', readOnly: false, PopUpData: 'projectCompany' },
    { header: 'Location Name', bind: 'Alld_FromLocation_Name', width: '15rem', type: 'text', readOnly: false },

    { header: 'Unit SysID', bind: 'Alld_ProdUnit_SysID', width: '6rem', type: 'text', readOnly: false, hide: true },
    { header: 'Unit Code', bind: 'Alld_ProdUnit_Code', width: '10rem', type: 'text', readOnly: false, PopUpData: 'Unit' },
    { header: 'Unit Name', bind: 'Alld_Prod_Unit', width: '15rem', type: 'text', readOnly: false },

    { header: 'Number of Employee', bind: 'Alld_Prod_Qty', width: '8rem', type: 'text', readOnly: false, hide: true },
    { header: 'Link Voucher No. 01', bind: 'Alld_Link_One', width: '8rem', type: 'text', readOnly: false },

    { header: 'Link Voucher No. 02', bind: 'Alld_Link_Two', type: 'text', hide: false, width: '8rem', align: 'left' },
    { header: 'Link Voucher No. 03', bind: 'Alld_Link_Three', type: 'number', hide: false, width: '8rem', align: 'left' },


    
    { header: 'Leave Start Date', bind: 'Alld_Lstart_Date', type: 'date', hide: false, width: '8rem', align: 'left' },
    { header: 'Leave End Date', bind: 'Alld_Lend_Date', type: 'date', hide: false, width: '8rem', align: 'left' },
    { header: 'No More Working', bind: 'Alld_NoMore_Working', type: 'string', hide: false, width: '8rem', align: 'left' },
