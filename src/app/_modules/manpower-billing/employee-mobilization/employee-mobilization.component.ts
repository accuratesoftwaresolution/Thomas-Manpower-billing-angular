...
@Component({
  selector: 'app-employee-mobilization',
  templateUrl: './employee-mobilization.component.html',
  styleUrls: ['./employee-mobilization.component.scss']
})
export class EmployeeMobilizationComponent implements OnInit {
  ...
  CriteriaTable = [
    { header: 'Criteria Grid SysID', bind: 'Hpd_EmSele_GridSysID', width: '8rem', type: 'text', readOnly: true, hide: true, mandatory: true },

    { header: 'Criteria SysID', bind: 'Hpd_EmSele_SysID', width: '8rem', type: 'text', readOnly: true, hide: true },
    { header: 'Criteria Code', bind: 'Hpd_EmSele_Code', width: '12rem', type: 'text', PopUpData: 'Employee' },
    { header: 'Criteria Name', bind: 'Hpd_EmSele_Name', width: '14rem', type: 'text' },


    { header: 'Required Y/N', bind: 'Hpd_EmMandatory_Yn', width: '8rem', type: 'text', readOnly: true, hide: false },

    { header: 'Select All', bind: 'Hpd_EmSelect_Option', width: '12rem', type: 'text', },

    { header: 'Remarks SysID', bind: 'Hpd_EmRemarks_SysID', width: '8rem', type: 'text', hide: true },
    { header: 'Remarks Code', bind: 'Hpd_EmRemarks_Code', width: '10rem', type: 'text', PopUpData: 'RemarksCode' },
    { header: 'Remarks Name', bind: 'Hpd_EmRemarks_Name', width: '14rem', type: 'text' }
