...
@Component({
  selector: 'app-project-employee-demobilization',
  templateUrl: './project-employee-demobilization.component.html',
  styleUrls: ['./project-employee-demobilization.component.scss']
})
export class ProjectEmployeeDemobilizationComponent implements OnInit {
TransactionSteps = [
  ...
  scrollableTabs: any[] = [
    ...
    { id: 1, title: "Criteria", content: "", visible: true },
  ...
  TableData = [
    { header: 'Grid SysID', bind: 'Alld_SysID', width: '8rem', type: 'text', readOnly: true, hide: true, mandatory: true },

    { header: 'Designation SysID', bind: 'Alld_Desig_SysID', width: '8rem', type: 'text', readOnly: true, hide: true },
    { header: 'Designation Code', bind: 'Alld_Desig_Code', width: '12rem', type: 'text', PopUpData: 'Designation' },
    { header: 'Designation Name', bind: 'Alld_Desig_Name', width: '14rem', type: 'text' },


    { header: 'Employee  SysID', bind: 'Alld_Prod_SysID', width: '8rem', type: 'text', readOnly: true, hide: true },
    { header: 'Employee  Code', bind: 'Alld_Prod_Code', width: '12rem', type: 'text', PopUpData: 'Employee' },
    { header: 'Employee   Name', bind: 'Alld_Prod_Name', width: '14rem', type: 'text' },
    ...
    { header: 'Unit Code', bind: 'Alld_ProdUnit_Code', width: '10rem', type: 'text',PopUpData: 'Employee' },
    { header: 'Unit Name', bind: 'Alld_Prod_Unit', width: '14rem', type: 'text' },

    { header: 'Number of Employee', bind: 'Alld_Prod_Qty', width: '10rem', type: 'number' },
