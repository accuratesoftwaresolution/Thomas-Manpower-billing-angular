...
@Component({
  selector: 'app-vehicle-demobilization',
  templateUrl: './vehicle-demobilization.component.html',
  styleUrls: ['./vehicle-demobilization.component.scss']
})
export class VehicleDemobilizationComponent implements OnInit {
    ...
    TableData = [
      { header: 'Vehicle HGrid SysID', bind: 'Alld_SysID', width: '8rem', type: 'text', readOnly: true, hide: true, mandatory: true },
  
      { header: 'Vehicle Type SysID', bind: 'Alld_VehType_SysID', width: '8rem', type: 'text', readOnly: true, hide: true },
      { header: 'Vehicle Type Code', bind: 'Alld_VehType_Code', width: '12rem', type: 'text', PopUpData: 'Designation' },
      { header: 'Vehicle Type  Name ', bind: 'Alld_VehType_Name', width: '14rem', type: 'text' },
  
  
      { header: 'Vehicle SysID', bind: 'Alld_Veh_SysID', width: '8rem', type: 'text', readOnly: true, hide: true },
      { header: 'Vehicle  Code', bind: 'Alld_Veh_Code', width: '12rem', type: 'text', PopUpData: 'Employee' },
      { header: 'Vehicle   Name', bind: 'Alld_Veh_Name', width: '14rem', type: 'text' },
      { header: 'Vehicle Plate Number', bind: 'Alld_Veh_PlateNo', width: '14rem', type: 'text' },
