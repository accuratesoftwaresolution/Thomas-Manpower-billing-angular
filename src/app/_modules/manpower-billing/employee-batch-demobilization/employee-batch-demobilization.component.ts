...
@Component({
  selector: 'app-employee-batch-demobilization',
  templateUrl: './employee-batch-demobilization.component.html',
  styleUrls: ['./employee-batch-demobilization.component.scss']
})
export class EmployeeBatchDemobilizationComponent implements OnInit {
  TransactionSteps = [
