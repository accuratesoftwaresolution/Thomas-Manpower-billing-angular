...
import { TblConstProjTransHead } from 'src/app/_dto/project-management/TblConstProjTransHead.dto';
import { TblConstProjDetail } from 'src/app/_dto/project-management/TblConstProjDetail.dto';
import { TbldConsProjCo } from 'src/app/_dto/project-management/TbldConsProjCo.dto';
import { TblConstClientContact } from 'src/app/_dto/project-management/TblConstClientContact.dto';
import { TblOurConstContact } from 'src/app/_dto/project-management/TblOurConstContact.dto';
import { TblConstCriteria } from 'src/app/_dto/project-management/TblConstCriteria.dto';
import { TblConstValue } from 'src/app/_dto/project-management/TblConstValue.dto';
import { TblConstTask } from 'src/app/_dto/project-management/TblConstTask.dto';
import { TblConstSubPro } from 'src/app/_dto/project-management/TblConstSubPro.dto';
import { ConstBudgCrea } from 'src/app/_dto/project-management/ConstBudgCrea.dto';
import { ConstBillStage } from 'src/app/_dto/project-management/ConstBillStage.dto';
@Component({
...
export class CreateNewProjectComponent implements OnInit {
  ...
  TblConstProjTransHead: TblConstProjTransHead = new TblConstProjTransHead()
  ...
  scrollableTabs: any[] = [
    { id: 0, title: "Client Contact Details", content: "", visible: true },
    { id: 1, title: "Our Site Contact Details", content: "", visible: true },
    { id: 2, title: "Criteria Checking", content: "", visible: true },


    { id: 3, title: "Contract Value Booking", content: "", visible: true },
    { id: 4, title: "Project Tasks Main process", content: "", visible: true },
    { id: 5, title: "Project Tasks Sub process", content: "", visible: true },


    { id: 6, title: "Project Budget Creation", content: "", visible: true },
    { id: 7, title: "Billing Stages", content: "", visible: true },


    // { id: 8, title: "Payment Terms", content: "", visible: true }, // Hidden tab example
    // { id: 9, title: "PO Number", content: "", visible: true },
    // { id: 10, title: "Tax", content: "Content for Tax", visible: true },
    // { id: 11, title: "Masters", content: "Content for Masters", visible: true },
    // { id: 12, title: "Other Fields", content: "Content for Other Fields", visible: true },
    // { id: 13, title: "User Key", content: "Content for User Key", visible: true },
    { id: 8, title: "Document Attachment", content: "Content for Document Attachment", visible: true },
  ];
  ...
  TableData = [
    ...
    { header: 'Contact Person', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_Contact_Person', type: 'text' },
    ...
    { header: 'Billing Rates Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_BillRate_Code', type: 'text', PopUpData: 'AccountFirstCode', },
    { header: 'Billing Rates Name', hide: false, mandatory: false, width: '14rem', data: '', manual: false, bind: 'Alld_BillRate_Name', type: 'text' },

    { header: 'Number of Days for Calculation', hide: false, mandatory: false, width: '6rem', data: '', manual: false, bind: 'Alld_NoDays_Cal', type: 'text', },
    ...
    { header: 'Customer Site Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_Site_Code', type: 'text', PopUp: true, PopUpData: 'CustomersiteCode', },
    { header: 'Customer Site Name', hide: false, mandatory: false, width: '14rem', data: '', manual: false, bind: 'Alld_Site_Name', type: 'text' },

    { header: 'Job SysID', hide: false, mandatory: false, width: '6rem', data: '', manual: false, bind: 'Alld_Job_SysID', type: 'number' },
    { header: 'Job Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_Job_Code', type: 'text', PopUp: true, PopUpData: 'JobCode', },
    ...
    { header: 'Remarks Name', hide: false, mandatory: false, width: '14rem', data: '', manual: false, bind: 'Alld_Remark_Name', type: 'number' },
  ...
  ClientTableData = [
    ...
    { header: 'Designation Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, PopUp: true, PopUpData: 'Alld_ClieDesig_Code', bind: 'Alld_Desig_Code', type: 'text' },
    ...
    // { header: 'Remarks SysID', hide: true, mandatory: false, width: '6rem', data: '', manual: false, bind: 'Alld_ClieRemark_SysID', type: 'number', },
    { header: 'Remarks Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_ClieRemark_Code', type: 'text', PopUp: true, PopUpData: 'RemarksCode' },
  ...
  SiteTableData = [
    ...
    { header: 'Designation Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, PopUp: true, PopUpData: 'Alld_OurDesig_Code', bind: 'Alld_Desig_Code', type: 'text' },
    ...
    { header: 'Remarks Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_OurRemark_Code', type: 'text', PopUp: true, PopUpData: 'RemarksCode' },
  ...
  CriteriaTableData = [
    ...
    { header: 'Criteria List Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, PopUp: true, PopUpData: 'Alld_CritCode', bind: 'Alld_Desig_Code', type: 'text' },
    ...
    { header: 'Remarks Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_CritRem_Code', type: 'text', PopUp: true, PopUpData: 'RemarksCode' },
  ...
  ContractValueTableData = [
    { header: 'Contract Value GridNo', hide: true, mandatory: true, width: '6rem', data: '', manual: false, bind: 'Alld_CValue_GridNo', type: 'number' },
    { header: 'Contract Value SysID', hide: true, mandatory: false, width: '6rem', data: '', manual: false, bind: 'Alld_CValue_SysID', type: 'number' },
    { header: 'Contract Value Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, PopUp: true, PopUpData: 'Alld_CValue_Code', bind: 'Alld_Desig_Code', type: 'text' },
    { header: 'Contract Value Name', hide: false, mandatory: false, width: '14rem', data: '', manual: false, bind: 'Alld_CValue_Name', type: 'text' },

    { header: 'FC Currency SysID', hide: true, mandatory: false, width: '6rem', data: '', manual: false, bind: 'Alld_CValue_FCSysID', type: 'number' },
    { header: 'FC Currency Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, PopUp: true, PopUpData: 'Alld_CValue_FCCode', bind: 'Alld_Desig_Code', type: 'text' },
    { header: 'FC Currency Name', hide: false, mandatory: false, width: '14rem', data: '', manual: false, bind: 'Alld_CValue_FCName', type: 'text' },

    { header: 'FC Amount', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_Desig_Code', type: 'text' },
    { header: 'Local Currency SysID', hide: true, mandatory: false, width: '14rem', data: '', manual: false, bind: 'Alld_CValue_LCurrSysID', type: 'text' },
    { header: 'Local Currency Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, PopUp: true, PopUpData: 'Alld_CValue_LCurrCode', bind: 'Alld_Desig_Code', type: 'text' },
    { header: 'Local Currency Name', hide: false, mandatory: false, width: '14rem', data: '', manual: false, bind: 'Alld_CValue_LCurrName', type: 'text' },

    { header: 'Local Conversation Rate', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_CValue_LCurrName', type: 'number', affects: [], readOnly: null, routeTo: "" },
    { header: 'Local Net Amount', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_CValue_LNetAmt', type: 'number', affects: [], readOnly: null, routeTo: "" },

    { header: 'Remarks SysID', hide: true, mandatory: false, width: '6rem', data: '', manual: false, bind: 'Alld_CValue_RemSysID', type: 'number', },
    { header: 'Remarks Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_CValue_RemCode', type: 'text', PopUp: true, PopUpData: 'RemarksCode' },
    { header: 'Remarks Name', hide: false, mandatory: false, width: '14rem', data: '', manual: false, bind: 'Alld_CValue_RemName', type: 'text' },

  ];
  ProjectMainTabledata = [
    { header: 'Project Main Process GridSysID', hide: true, mandatory: true, width: '6rem', data: '', manual: false, bind: 'Alld_CTask_GridSysID', type: 'number' },
    { header: 'Project Main Process SysID', hide: true, mandatory: false, width: '6rem', data: '', manual: false, bind: 'Alld_CTask_GridSysID', type: 'number' },
    { header: 'Project Main Process Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, PopUp: true, PopUpData: 'Alld_CTask_ProcCode', bind: 'Alld_Desig_Code', type: 'text' },
    { header: 'Project Main Process Name', hide: false, mandatory: false, width: '14rem', data: '', manual: false, bind: 'Alld_CTask_ProcName', type: 'text' },

    { header: 'Remarks SysID', hide: true, mandatory: false, width: '6rem', data: '', manual: false, bind: 'Alld_CTask_RemSysID', type: 'number', },
    { header: 'Remarks Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_CTask_RemCode', type: 'text', PopUp: true, PopUpData: 'RemarksCode' },
    { header: 'Remarks Name', hide: false, mandatory: false, width: '14rem', data: '', manual: false, bind: 'Alld_CTask_RemName', type: 'text' },

  ];
  ProjectSubTabledata = [
    { header: 'Project Sub Process GridSysID', hide: true, mandatory: true, width: '6rem', data: '', manual: false, bind: 'Alld_CSubPro_GridSysID', type: 'number' },
    { header: 'Project Sub Process SysID', hide: true, mandatory: false, width: '6rem', data: '', manual: false, bind: 'Alld_CSubPro_ProcSysID', type: 'number' },
    { header: 'Project Sub Process Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, PopUp: true, PopUpData: 'Alld_CSubPro_ProcCode', bind: 'Alld_Desig_Code', type: 'text' },
    { header: 'Project Sub Process Name', hide: false, mandatory: false, width: '14rem', data: '', manual: false, bind: 'Alld_CSubPro_ProcName', type: 'text' },

    { header: 'Remarks SysID', hide: true, mandatory: false, width: '6rem', data: '', manual: false, bind: 'Alld_CSubPro_RemSysID', type: 'number', },
    { header: 'Remarks Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_CSubPro_RemCode', type: 'text', PopUp: true, PopUpData: 'RemarksCode' },
    { header: 'Remarks Name', hide: false, mandatory: false, width: '14rem', data: '', manual: false, bind: 'Alld_CSubPro_RemName', type: 'text' },

  ];


  Budgetcreationtabledata = [
    { header: 'Project Task Budget Grid SysID', hide: true, mandatory: true, width: '6rem', data: '', manual: false, bind: 'Alld_CBudgCre_GridSysID', type: 'number' },
    { header: 'Project Task Budget SysID', hide: true, mandatory: false, width: '6rem', data: '', manual: false, bind: 'Alld_CBudgCrea_SysID', type: 'number' },
    { header: 'Project Task Budget Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, PopUp: true, PopUpData: 'Alld_CSubPro_ProcCode', bind: 'Alld_CBudgCrea_Code', type: 'text' },
    { header: 'Project Task Budget Name', hide: false, mandatory: false, width: '14rem', data: '', manual: false, bind: 'Alld_CBudgCrea_Name', type: 'text' },

    { header: 'Currency SysID', hide: true, mandatory: false, width: '6rem', data: '', manual: false, bind: 'Alld_CBudgCrea_CurrSysID', type: 'number', },
    { header: 'Currency Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_CBudgCrea_CurrCode', type: 'text', PopUp: true, PopUpData: 'CurrencyCode' },
    { header: 'Currency Name', hide: false, mandatory: false, width: '14rem', data: '', manual: false, bind: 'Alld_CBudgCrea_CurrName', type: 'text' },
    { header: 'Currency Rate', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_CBudgCrea_CurrRate', type: 'text' },
    { header: 'FC Amount', hide: false, mandatory: false, width: '14rem', data: '', manual: false, bind: 'Alld_CBudgCrea_FCAmt', type: 'text' },
    { header: 'Local Currency Amount', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_CBudgCrea_LCurrAmt', type: 'text' },


    { header: 'Remarks SysID', hide: true, mandatory: false, width: '6rem', data: '', manual: false, bind: 'Alld_CBudgCrea_RemSysID', type: 'number', },
    { header: 'Remarks Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_CBudgCrea_RemCode', type: 'text', PopUp: true, PopUpData: 'RemarksCode' },
    { header: 'Remarks Name', hide: false, mandatory: false, width: '14rem', data: '', manual: false, bind: 'Alld_CBudgCrea_RemName', type: 'text' },

  ];

  
  Billintabledata = [
    { header: 'Billing Stages Grid SysID', hide: true, mandatory: true, width: '6rem', data: '', manual: false, bind: 'Alld_CBillStage_GridSysID', type: 'number' },
    { header: 'Billing Stages SysID', hide: true, mandatory: false, width: '6rem', data: '', manual: false, bind: 'Alld_CBillStage_SysID', type: 'number' },
    { header: 'Billing Stages Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, PopUp: true, PopUpData: 'Alld_CSubPro_ProcCode', bind: 'Alld_CBillStage_Code', type: 'text' },
    { header: 'Billing Stages Name', hide: false, mandatory: false, width: '14rem', data: '', manual: false, bind: 'Alld_CBillStage_Name', type: 'text' },

    { header: 'Billing Parentage', hide: true, mandatory: false, width: '6rem', data: '', manual: false, bind: 'Alld_CBillStage_BillPerce', type: 'number', },
    { header: 'Billing Amount', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_CBillStage_BillAmt', type: 'text', PopUp: true, PopUpData: 'CurrencyCode' },
    
    { header: 'Currency SysID', hide: true, mandatory: false, width: '6rem', data: '', manual: false, bind: 'Alld_CBillStage_CurrSysID', type: 'number', },
    { header: 'Currency Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_CBillStage_CurrCode', type: 'text', PopUp: true, PopUpData: 'CurrencyCode' },
    { header: 'Currency Name', hide: false, mandatory: false, width: '14rem', data: '', manual: false, bind: 'Alld_CBillStage_CurrName', type: 'text' },
    { header: 'Conversion Rate', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_CBillStage_CurrRate', type: 'text' },

    { header: 'Remarks SysID', hide: true, mandatory: false, width: '6rem', data: '', manual: false, bind: 'Alld_CBillStage_RemSysID', type: 'number', },
    { header: 'Remarks Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_CBillStage_RemCode', type: 'text', PopUp: true, PopUpData: 'RemarksCode' },
    { header: 'Remarks Name', hide: false, mandatory: false, width: '14rem', data: '', manual: false, bind: 'Alld_CBillStage_RemName', type: 'text' },
  ...
  ngOnInit(): void {
    ...
    this.TblConstProjTransHead.TblConstProjDetail.push(new TblConstProjDetail())

    this.TblConstProjTransHead.TbldConsProjCo.push(new TbldConsProjCo())

    this.TblConstProjTransHead.TblConstClientContact.push(new TblConstClientContact())

    this.TblConstProjTransHead.TblOurConstContact.push(new TblOurConstContact())

    this.TblConstProjTransHead.TblConstCriteria.push(new TblConstCriteria())

    this.TblConstProjTransHead.TblConstValue.push(new TblConstValue())

    this.TblConstProjTransHead.TblConstTask.push(new TblConstTask());

    this.TblConstProjTransHead.TblConstSubPro.push(new TblConstSubPro())

    this.TblConstProjTransHead.ConstBudgCrea.push(new ConstBudgCrea())

    this.TblConstProjTransHead.ConstBillStage.push(new ConstBillStage());



    this.TblConstProjTransHead.Allh_JobQR_Code = 'assets/images/qr-code/site-qr.png';
    this.TblConstProjTransHead.Allh_JobBar_Code = 'assets/images/qr-code/barcode.avif';
  ...
  Save() {
    ...
    console.log("saved the data:::::::", this.TblConstProjTransHead)
  ...
  addRow(table: any, index: number) {
    ...
    if (table == 'TblConstProjDetail') {
      const newRow = new TblConstProjDetail()
      this.TblConstProjTransHead.TblConstProjDetail.splice(index + 1, 0, newRow);
    }
