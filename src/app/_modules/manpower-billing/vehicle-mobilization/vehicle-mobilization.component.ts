...
@Component({
  selector: 'app-vehicle-mobilization',
  templateUrl: './vehicle-mobilization.component.html',
  styleUrls: ['./vehicle-mobilization.component.scss']
})
export class VehicleMobilizationComponent implements OnInit {
