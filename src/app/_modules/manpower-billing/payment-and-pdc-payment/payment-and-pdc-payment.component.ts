...
@Component({
  selector: 'app-payment-and-pdc-payment',
  templateUrl: './payment-and-pdc-payment.component.html',
  styleUrls: ['./payment-and-pdc-payment.component.scss']
})
export class PaymentAndPdcPaymentComponent implements OnInit {
  ...
  TableData = [
    { header: 'BP Grid SysID', bind: 'Alld_SysID', width: '8rem', type: 'text', readOnly: true, hide: true, mandatory: true },

    { header: 'Voucher No', bind: 'Alld_Vou_Number', width: '8rem', type: 'text', readOnly: true,  },
    { header: 'Voucher Date', bind: 'Alld_Vou_Date', width: '12rem', type: 'Date'},


    { header: 'Cash/Bank SysID', bind: 'Alld_AccFirst_SysID', width: '8rem', type: 'text', readOnly: true, hide: true },
    { header: 'Cash/Bank Code', bind: 'Alld_AccFirst_Code', width: '12rem', type: 'text', PopUpData: 'Employee' },
    { header: 'Cash/Bank  Name', bind: 'Alld_AccFirst_Name', width: '14rem', type: 'text' },


    { header: 'Expense Headed SysID', bind: 'Alld_AccSecond_SysID', width: '8rem', type: 'text', readOnly: true, hide: true },
    { header: 'Expense Headed Code', bind: 'Alld_AccSecond_Code', width: '12rem', type: 'text', PopUpData: 'Employee' },
    { header: 'Expense Headed Name', bind: 'Alld_AccSecond_Name', width: '14rem', type: 'text' },

    { header: 'Amount', bind: 'Alld_Gross_Amount', width: '12rem', type: 'number'},
    { header: 'PDC Date', bind: 'Alld_Due_Date', width: '12rem', type: 'Date'},
