...
@Component({
  ...
  templateUrl: './employee-batch.component.html',
  styleUrls: ['./employee-batch.component.scss']
})
export class EmployeeBatchComponent implements OnInit {
  TransactionSteps = [
  ...
  TableData = [
    ...
    { header: 'Employee Batch SysID', bind: 'Alld_MRVBatch_SysID', width: '8rem', type: 'text', hide: true },
    { header: 'Employee Batch Code', bind: 'Alld_MRVBatch_Code', width: '10rem', type: 'text', PopUpData: 'Unit' },
    { header: 'Employee Batch Name', bind: 'Alld_MRVBatch_Name', width: '14rem', type: 'text' },
