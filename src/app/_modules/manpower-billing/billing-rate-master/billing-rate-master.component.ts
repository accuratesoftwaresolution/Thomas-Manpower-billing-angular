...
import { TblHPBillRate } from 'src/app/_dto/Billing-rate-master/TblHPBillRate.dto';
import { TbldPBillRate } from 'src/app/_dto/Billing-rate-master/TbldPBillRate.dto';
import { TbldPBillRateCo } from 'src/app/_dto/Billing-rate-master/TbldPBillRateCo.dto';
@Component({
  selector: 'app-billing-rate-master',
  templateUrl: './billing-rate-master.component.html',
  styleUrls: ['./billing-rate-master.component.scss']
})
export class BillingRateMasterComponent implements OnInit {
  ...
  TblHPBillRate: TblHPBillRate = new TblHPBillRate()
  ...
  scrollableTabs: any[] = [
    ...
    { id: 1, title: "Payment Terms", content: "", visible: true }, // Hidden tab example
    { id: 2, title: "PO Number", content: "", visible: true },
    { id: 3, title: "Tax", content: "Content for Tax", visible: true },
    { id: 4, title: "Masters", content: "Content for Masters", visible: true },
    { id: 5, title: "Other Fields", content: "Content for Other Fields", visible: true },
    { id: 6, title: "User Key", content: "Content for User Key", visible: true },
    { id: 7, title: "Document Attachment", content: "Content for Document Attachment", visible: true },
  ];
  ...
  TableData = [
    { header: 'Grid SysID', hide: true, mandatory: true, width: '6rem', data: '', manual: false, bind: 'DPdBRate_GridSysID', type: 'number', readOnly: null },
  
    { header: 'Billing Rates SysID', hide: true, mandatory: false, width: '6rem', data: '', manual: false, bind: 'DPdBRate_SysID', type: 'text', affects: [], readOnly: null, routeTo: "" },
    { header: 'Billing Rates Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'DPdBRate_Code', type: 'text', PopUpData: 'AccountFirstCode', },
    { header: 'Billing Rates Name', hide: false, mandatory: false, width: '14rem', data: '', manual: false, bind: 'DPdBRate_Name', type: 'text' },

    { header: 'Number of Days for Calculation', hide: false, mandatory: false, width: '6rem', data: '', manual: false, bind: 'DPdBRate_NoDaysCalc', type: 'text', },
    { header: 'Fixed Hours', hide: false, mandatory: false, width: '6rem', data: '', manual: false, bind: 'DPdBRate_FixHrs', type: 'text' },
    { header: 'Overtime Rate', hide: false, mandatory: false, width: '6rem', data: '', manual: false, bind: 'DPdBRate_OTRate', type: 'text' },
    { header: 'HOT Rate', hide: false, mandatory: true, width: '6rem', data: '', manual: false, bind: 'DPdBRate_HOTRate', type: 'number' },

    { header: 'Job SysID', hide: true, mandatory: false, width: '6rem', data: '', manual: false, bind: 'DPdBRate_JobSysID', type: 'number' },
    { header: 'Job Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'DPdBRate_JobCode', type: 'text', PopUp: true, PopUpData: 'JobCode', },
    { header: 'Job Name', hide: false, mandatory: false, width: '14rem', data: '', manual: false, bind: 'DPdBRate_JobName', type: 'text' },

    { header: 'Remarks SysID', hide: true, mandatory: false, width: '6rem', data: '', manual: false, bind: 'DPdBRate_RemSysID', type: 'number', },
    { header: 'Remarks Code', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'DPdBRate_RemCode', type: 'text', PopUp: true, PopUpData: 'RemarksCode' },
    { header: 'Remarks Name', hide: false, mandatory: false, width: '14rem', data: '', manual: false, bind: 'DPdBRate_RemName', type: 'number' },
  ];
  ...
  ngOnInit(): void {
    this.TblHPBillRate.TbldPBillRate.push(new TbldPBillRate())
    this.TblHPBillRate.TbldPBillRateCo.push(new TbldPBillRateCo())
  ...
  Save() {
    ...
    console.log("saved the data:::::::", this.TblHPBillRate)
  ...
  addRow(table: any, index: number) {
    ...
    if (table == 'TbldPBillRate') {
         const newRow = new TbldPBillRate()
         this.TblHPBillRate.TbldPBillRate.splice(index + 1, 0, newRow);
       }
