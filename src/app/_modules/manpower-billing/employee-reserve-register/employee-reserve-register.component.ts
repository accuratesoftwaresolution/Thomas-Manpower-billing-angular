...
@Component({
  selector: 'app-employee-reserve-register',
  templateUrl: './employee-reserve-register.component.html',
  styleUrls: ['./employee-reserve-register.component.scss']
})
export class EmployeeReserveRegisterComponent implements OnInit {
  ...
  TableData = [
    { field: 'Alld_SysID', header: 'Employee Grid SysID', bind: 'Alld_SysID', width: '8rem', type: 'text', readOnly: true, hide: true, mandatory: true },
    { field: 'Alld_EmpSysID', header: 'Employee SysID', bind: 'Alld_Prod_SysID', width: '8rem', type: 'text', readOnly: true, hide: true },
    { field: 'Alld_EmpCode', header: 'Employee Code', bind: 'Alld_Prod_Code', width: '12rem', type: 'text', PopUpData: 'Employee' },
    { field: 'Alld_EmpName', header: 'Employee Name', bind: 'Alld_ProdShort_Name', width: '14rem', type: 'text' },

    { field: 'Alld_EmpModl_SysID', header: 'Employees Module SysID', bind: 'Alld_EmplModu_SysID', width: '8rem', type: 'text', hide: true },
    { field: 'Alld_EmpModl_Code', header: 'Employees Module Code', bind: 'Alld_EmplModu_Code', width: '12rem', type: 'text', PopUpData: 'EmployeeModule' },
    { field: 'Alld_EmpModl_Name', header: 'Employees Module Name', bind: 'Alld_EmplModu_Name', width: '14rem', type: 'text' },

    { field: 'Alld_JobSysID', header: 'Job SysID', bind: 'Alld_Job_SysID', width: '8rem', type: 'text', hide: true },
    { field: 'Alld_JobCode', header: 'Job Code', bind: 'Alld_Job_Code', width: '10rem', type: 'text' },
    { field: 'Alld_JobName', header: 'Job Name', bind: 'Alld_Job_Name', width: '14rem', type: 'text' },

    { field: 'Alld_LocationSysID', header: 'Location SysID', bind: 'Alld_FromLocation_SysID', width: '8rem', type: 'text', hide: true },
    { field: 'Alld_LocationCode', header: 'Location Code', bind: 'Alld_FromLocation_Code', width: '10rem', type: 'text', PopUpData: 'projectCompany' },
    { field: 'Alld_LocationName', header: 'Location Name', bind: 'Alld_FromLocation_Name', width: '14rem', type: 'text' },

    { field: 'Alld_UnitSysID', header: 'Unit SysID', bind: 'Alld_ProdUnit_SysID', width: '8rem', type: 'text', hide: true },
    { field: 'Alld_UnitCode', header: 'Unit Code', bind: 'Alld_ProdUnit_Code', width: '10rem', type: 'text', PopUpData: 'Unit' },
    { field: 'Alld_UnitName', header: 'Unit Name', bind: 'Alld_Prod_Unit', width: '14rem', type: 'text' },

    { field: 'Alld_ProdQty', header: 'Number of Employee', bind: 'Alld_Prod_Qty', width: '10rem', type: 'number' },

    { field: 'Alld_Link_One', header: 'Link Voucher No. 01', bind: 'Alld_Link_One', width: '10rem', type: 'text' },
    { field: 'Alld_Link_Two', header: 'Link Voucher No. 02', bind: 'Alld_Link_Two', width: '10rem', type: 'text' },
    { field: 'Alld_Link_Three', header: 'Link Voucher No. 03', bind: 'Alld_Link_Three', width: '10rem', type: 'text' },


    { field: 'Alld_Remark_SysID', header: 'Remarks SysID', bind: 'Alld_Remark_SysID', width: '8rem', type: 'text', hide: true },
    { field: 'Alld_Remark_Code', header: 'Remarks Code', bind: 'Alld_Remark_Code', width: '10rem', type: 'text', PopUpData: 'ClientCode' },
    { field: 'Alld_Remark_Name', header: 'Remarks Name', bind: 'Alld_Remark_Name', width: '14rem', type: 'text' },

    { field: 'Release', header: 'Release', bind: 'Alld_EmRelease_All', width: '10rem', type: 'text', PopUpData: 'ClientCode' },
