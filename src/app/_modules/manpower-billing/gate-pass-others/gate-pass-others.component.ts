...
@Component({
  selector: 'app-gate-pass-others',
  templateUrl: './gate-pass-others.component.html',
  styleUrls: ['./gate-pass-others.component.scss']
})
export class GatePassOthersComponent implements OnInit {
  ...
  TableData = [
    { header: 'Gate Pass Grid SysID', bind: 'Alld_SysID', width: '6rem', type: 'text', readOnly: true, hide: 'true' },
    { header: 'Employee SysID', bind: 'Alld_Prod_SysID', width: '6rem', type: 'text', readOnly: false, hide: "true" },
    { header: 'Employee Code', bind: 'Alld_Prod_Code', width: '10rem', type: 'text', readOnly: false, PopUpData: 'Employee' },
    { header: 'Employee Name', bind: 'Alld_ProdShort_Name', width: '15rem', type: 'text', readOnly: false },

    { header: 'Employees Module SysID', bind: 'Alld_EmplModu_SysID', width: '8rem', type: 'text', readOnly: false, hide: true },
    { header: 'Employees Module Code', bind: 'Alld_EmplModu_Code', width: '10rem', type: 'text', readOnly: false, PopUpData: 'EmployeeModule' },
    { header: 'Employees Module Name', bind: 'Alld_EmplModu_Name', width: '15rem', type: 'text', readOnly: false },

    { header: 'Project Company SysID', bind: 'Alld_ProjCompanySysID', width: '6rem', type: 'text', readOnly: true, hide: true },
    { header: 'Project Company Code', bind: 'Alld_ProjCompany_Code', width: '10rem', type: 'text', readOnly: false, PopUpData: 'projectCompany' },
    { header: 'Project Company Name', bind: 'Alld_ProjCompany_Name', width: '15rem', type: 'text', readOnly: false },

    { header: 'Designation SysID', bind: 'Alld_Desig_SysID', width: '6rem', type: 'text', readOnly: false, hide: true },
    { header: 'Designation Code', bind: 'Alld_Desig_Code', width: '10rem', type: 'text', readOnly: false, PopUpData: 'designation' },
    { header: 'Designation Name', bind: 'Alld_Desig_Name', width: '15rem', type: 'text', readOnly: false },

    { header: 'Qatar SysID', bind: 'Alld_QatarID_SysID', width: '6rem', type: 'text', readOnly: false, hide: true },
    { header: 'Qatar ID Code', bind: 'Alld_QatarID_Code', width: '10rem', type: 'text', readOnly: false, PopUpData: 'qatarID' },
    { header: 'Qatar ID Name', bind: 'Alld_QatarID_Name', width: '15rem', type: 'text', readOnly: false },

    { header: 'Qatar ID Issue Date', bind: 'Alld_QatarIDIssue_Date', type: 'date', hide: false, width: '8rem', align: 'left' },
    { header: 'QID (DAYS EXP)', bind: 'Alld_QatarIDExp_Days', type: 'number', hide: false, width: '8rem', align: 'left' },
    { header: 'Qatar ID Expiry Date', bind: 'Alld_QatarIDExp_Date', type: 'date', hide: false, width: '8rem', align: 'left' },

    { header: 'GP EXP SysID', bind: 'Alld_GPExp_SysID', type: 'text', hide: true, width: '8rem', align: 'left' },
    { header: 'GP EXP ID Code', bind: 'Alld_GPExp_Code', type: 'text', hide: false, width: '10rem', align: 'left', Popup: true, PopUpData: 'GPExpCode' },
    { header: 'GP EXP ID Name', bind: 'Alld_GPExp_Name', type: 'text', hide: false, width: '15rem', align: 'left' },

    { header: 'GP EXP Issue Date', bind: 'Alld_GPExp_Date', type: 'date', hide: false, width: '8rem', align: 'left' },
    { header: 'GP EXP (DAYS EXP)', bind: 'Alld_GPExp_Days', type: 'number', hide: false, width: '6rem', align: 'left' },
    { header: 'GP EXP ID Expiry Date', bind: 'Alld_GPExp_ExpDate', type: 'date', hide: false, width: '8rem', align: 'left' },

    { header: 'FP EXP ID SysID', bind: 'Alld_FPExp_SysID', type: 'text', hide: true, width: '8rem', align: 'left', readonly: 'true' },
    { header: 'FP EXP ID Code', bind: 'Alld_FPExp_Code', type: 'text', hide: false, width: '10rem', align: 'left', Popup: true, PopUpData: 'FPExpCode' },
    { header: 'FP EXP ID Name', bind: 'Alld_FPExp_Name', type: 'text', hide: false, width: '15rem', align: 'left' },

    { header: 'FP EXP ID Issue Date', bind: 'Alld_FPExp_Date', type: 'date', hide: false, width: '8rem', align: 'left' },
    { header: 'FP EXP ID (DAYS EXP)', bind: 'Alld_FPExp_Days', type: 'number', hide: false, width: '6rem', align: 'left' },
    { header: 'FP EXP ID Expiry Date', bind: 'Alld_FPExp_ExpDate', type: 'date', hide: false, width: '8rem', align: 'left' },

    { header: 'Client SysID', bind: 'Alld_Client_SysID', type: 'text', hide: true, width: '8rem', align: 'left', mandatory: 'true' },
    { header: 'Client Code', bind: 'Alld_Client_Code', type: 'text', hide: false, width: '10rem', align: 'left', Popup: true, PopUpData: 'ClientCode' },
    { header: 'Client Name', bind: 'Alld_Client_Name', type: 'text', hide: false, width: '15rem', align: 'left' },

    { header: 'Project SysID', bind: 'Alld_Project_SysID', type: 'text', hide: true, width: '8rem', align: 'left' },
    { header: 'Project Code', bind: 'Alld_Project_Code', type: 'text', hide: false, width: '10rem', align: 'left', Popup: true, PopUpData: 'ProjectCode' },
    { header: 'Project Name', bind: 'Alld_Project_Name', type: 'text', hide: false, width: '15rem', align: 'left' },

    { header: 'End Client SysID', bind: 'Alld_EndClient_SysID', type: 'text', hide: true, width: '8rem', align: 'left' },
    { header: 'End Client Code', bind: 'Alld_EndClient_Code', type: 'text', hide: false, width: '10rem', align: 'left', Popup: true, PopUpData: 'EndClientCode' },
    { header: 'End Client Name', bind: 'Alld_EndClient_Name', type: 'text', hide: false, width: '15rem', align: 'left' },

    { header: 'GP SysID', bind: 'Alld_GpSysID', type: 'text', hide: true, width: '8rem', align: 'left' },
    { header: 'GP Code', bind: 'Alld_GpCode', type: 'text', hide: false, width: '10rem', align: 'left', Popup: true, PopUpData: 'GpCode' },
    { header: 'GP Name', bind: 'Alld_GpName', type: 'text', hide: false, width: '12rem', align: 'left' },

    { header: 'GP Location SysID', bind: 'Alld_GPLoc_SysID', type: 'text', hide: true, width: '8rem', align: 'left' },
    { header: 'GP Location Code', bind: 'Alld_GPLoc_Code', type: 'text', hide: false, width: '10rem', align: 'left', Popup: true, PopUpData: 'GPLocCode' },
    { header: 'GP Location Name', bind: 'Alld_GPLoc_Name', type: 'text', hide: false, width: '12rem', align: 'left' },

    { header: 'Gate Number SysID', bind: 'Alld_GateNo_SysID', type: 'text', hide: true, width: '8rem', align: 'left' },
    { header: 'Gate Number Code', bind: 'Alld_Gate_No_Code', type: 'text', hide: false, width: '10rem', align: 'left', Popup: true, PopUpData: 'GateCode' },
    { header: 'Gate Number Name', bind: 'Alld_GateNo_Name', type: 'text', hide: false, width: '12rem', align: 'left' },

    { header: 'Remarks SysID', bind: 'Alld_Remarks_SysID', type: 'text', hide: true, width: '8rem', align: 'left' },
    { header: 'Remarks Code', bind: 'Alld_Remark_Code', type: 'text', hide: false, width: '10rem', align: 'left', Popup: true, PopUpData: 'RemarkCode' },
    { header: 'Remarks Name', bind: 'Alld_Remark_Name', type: 'text', hide: false, width: '12rem', align: 'left' },
