...
@Component({
  selector: 'app-employee-selection-agencies',
  templateUrl: './employee-selection-agencies.component.html',
  styleUrls: ['./employee-selection-agencies.component.scss']
})
export class EmployeeSelectionAgenciesComponent implements OnInit {
  ...
  scrollableTabs: any[] = [
    ...
    { id: 1, title: "Selection Criteria", content: "", visible: true },

    { id: 2, title: "Other Expenses", content: "Content for Other Expenses", visible: true },
    { id: 3, title: "Payment Terms", content: "", visible: true }, // Hidden tab example
    { id: 4, title: "PO Number", content: "", visible: true },
    { id: 5, title: "Tax", content: "Content for Tax", visible: true },
    { id: 6, title: "Masters", content: "Content for Masters", visible: true },
    { id: 7, title: "Other Fields", content: "Content for Other Fields", visible: true },
    { id: 8, title: "Journal", content: "Content for Journal", visible: true },
    { id: 9, title: "User Key", content: "Content for User Key", visible: true },
    { id: 10, title: "Vessel Booking", content: "Content for Vessel Booking", visible: true },
    { id: 11, title: "QA/QC", content: "Content for QA/QC", visible: true },
    { id: 12, title: "WH Management", content: "Content for WH Management", visible: true },
    { id: 13, title: "Document Attachment", content: "Content for Document Attachment", visible: true },
    { id: 14, title: "LC Details", content: "Content for LC", visible: true },
    { id: 15, title: "Landed Cost Expense", content: "Content for Landed Cost Expense", visible: true },
  ];
  ...
  TableData = [
    ...
    //{ field: 'Visa Quota Grid SysID', header: 'Selection  Grid SysID', hide: true, mandatory: false, width: '3rem', data: "12345", manual: false, bind: "Alld_SysID", type: 'text' },

    //{ field: 'Employee SysID', header: 'Project Company SysID', hide: true, mandatory: true, width: '8rem', data: '12345678912345', manual: true, PopUp: true, PopUpData: 'ProductCode', bind: "Alld_Prod_SysID", routeTo: "product-master", type: 'text' },
    { field: 'Project Company Code', header: 'Employee Code', hide: false, mandatory: false, width: '10rem', data: '123456789123456789123456789', manual: false, bind: "Alld_Prod_Code", Popup: true, PopUpData: 'ProductCode', type: 'text' },
    { field: 'Project Company Name', header: 'Employee Name', hide: false, mandatory: false, width: '15rem', data: '123456789123456789123456789', manual: false, bind: "Alld_ProdShort_Name", type: 'text' },

    //{ field: 'Visa Quota  Designation SysID', header: 'Employee Module SysID', hide: true, mandatory: false, width: '4rem', data: '123456', manual: true, bind: "Alld_EmplModu_SysID", affects: ['Alld_Gross_Amount', 'Alld_Net_Amount'], align: 'left', type: 'number' },
    { field: 'Visa Quota  Designation Code', header: 'Employee Module Code', hide: false, mandatory: false, width: '10rem', data: '12345678912345', manual: false, bind: "Alld_EmplModu_Code", align: 'left', type: 'text', Popup: true, PopUpData: 'visadesignationcode' },
    { field: 'Visa Quota  Designation Name', header: 'Employee Module Name', hide: false, mandatory: false, width: '15rem', data: '12345678912345', manual: false, bind: "Alld_EmplModu_Name", affects: ['Alld_Gross_Amount', 'Alld_Net_Amount'], align: 'left', type: 'text' },

    //{ field: 'Visa Quota  Designation SysID', header: 'Designation SysID', hide: true, mandatory: false, width: '4rem', data: '123456', manual: true, bind: "Alld_Desig_SysID", affects: ['Alld_Gross_Amount', 'Alld_Net_Amount'], align: 'left', type: 'number' },
    { field: 'Visa Quota  Designation Code', header: 'Designation Code', hide: false, mandatory: false, width: '10rem', data: '12345678912345', manual: false, bind: "Alld_Desig_Code", align: 'left', type: 'text', Popup: true, PopUpData: 'visadesignationcode' },
    { field: 'Visa Quota  Designation Name', header: 'Designation Name', hide: false, mandatory: false, width: '15rem', data: '12345678912345', manual: false, bind: "Alld_Desig_Name", affects: ['Alld_Gross_Amount', 'Alld_Net_Amount'], align: 'left', type: 'text' },

    //{ field: 'Visa Quota  Designation SysID', header: 'Nationality SysID', hide: true, mandatory: false, width: '4rem', data: '123456', manual: true, bind: "Alld_Nationality_SysID	", affects: ['Alld_Gross_Amount', 'Alld_Net_Amount'], align: 'left', type: 'number' },
    { field: 'Visa Quota  Designation Code', header: 'Nationality Code', hide: false, mandatory: false, width: '10rem', data: '12345678912345', manual: false, bind: "Alld_Nationality_Code", align: 'left', type: 'text', Popup: true, PopUpData: 'visadesignationcode' },
    { field: 'Visa Quota  Designation Name', header: 'Nationality Name', hide: false, mandatory: false, width: '15rem', data: '12345678912345', manual: false, bind: "Alld_Nationality_Name", affects: ['Alld_Gross_Amount', 'Alld_Net_Amount'], align: 'left', type: 'text' },



    //{ field: 'Visa Quota  Designation SysID', header: 'Offer Letter issued SysID', hide: true, mandatory: false, width: '4rem', data: '123456', manual: true, bind: "Alld_OfferLetter_SysID		", affects: ['Alld_Gross_Amount', 'Alld_Net_Amount'], align: 'left', type: 'number' },
    { field: 'Visa Quota  Designation Code', header: 'Offer Letter issued Code', hide: false, mandatory: false, width: '10rem', data: '12345678912345', manual: false, bind: "Alld_OfferLetter_Code", align: 'left', type: 'text', Popup: true, PopUpData: 'visadesignationcode' },
    { field: 'Visa Quota  Designation Name', header: 'Offer Letter issued Name', hide: false, mandatory: false, width: '15rem', data: '12345678912345', manual: false, bind: "Alld_OfferLetter_Name", affects: ['Alld_Gross_Amount', 'Alld_Net_Amount'], align: 'left', type: 'text' },



    //{ field: 'Visa Quota  Designation SysID', header: 'Signed Letter issued SysID', hide: true, mandatory: false, width: '4rem', data: '123456', manual: true, bind: "Alld_SignedOffer_SysID		", affects: ['Alld_Gross_Amount', 'Alld_Net_Amount'], align: 'left', type: 'number' },
    { field: 'Visa Quota  Designation Code', header: 'Signed Letter issued Code', hide: false, mandatory: false, width: '10rem', data: '12345678912345', manual: false, bind: "Alld_SignedOffer_Code", align: 'left', type: 'text', Popup: true, PopUpData: 'visadesignationcode' },
    { field: 'Visa Quota  Designation Name', header: 'Signed Letter issued Name', hide: false, mandatory: false, width: '15rem', data: '12345678912345', manual: false, bind: "Alld_SignedOffer_Name", affects: ['Alld_Gross_Amount', 'Alld_Net_Amount'], align: 'left', type: 'text' },


    //{ field: 'Visa Quota  Designation SysID', header: 'Visa Request SysID', hide: true, mandatory: false, width: '4rem', data: '123456', manual: true, bind: "Alld_VisaReq_SysID		", affects: ['Alld_Gross_Amount', 'Alld_Net_Amount'], align: 'left', type: 'number' },
    { field: 'Visa Quota  Designation Code', header: 'Visa Request Code', hide: false, mandatory: false, width: '10rem', data: '12345678912345', manual: false, bind: "Alld_VisaReq_Code", align: 'left', type: 'text', Popup: true, PopUpData: 'visadesignationcode' },
    { field: 'Visa Quota  Designation Name', header: 'Visa Request Name', hide: false, mandatory: false, width: '15rem', data: '12345678912345', manual: false, bind: "Alld_VisaReq_Name", affects: ['Alld_Gross_Amount', 'Alld_Net_Amount'], align: 'left', type: 'text' },



    //{ field: 'Visa Quota  Designation SysID', header: 'Visa Applied SysID', hide: true, mandatory: false, width: '4rem', data: '123456', manual: true, bind: "Alld_VisaApplied_SysID		", affects: ['Alld_Gross_Amount', 'Alld_Net_Amount'], align: 'left', type: 'number' },
    { field: 'Visa Quota  Designation Code', header: 'Visa Applied Code', hide: false, mandatory: false, width: '10rem', data: '12345678912345', manual: false, bind: "Alld_VisaApplied_Code", align: 'left', type: 'text', Popup: true, PopUpData: 'visadesignationcode' },
    { field: 'Visa Quota  Designation Name', header: 'Visa Applied Name', hide: false, mandatory: false, width: '15rem', data: '12345678912345', manual: false, bind: "Alld_VisaApplied_Name", affects: ['Alld_Gross_Amount', 'Alld_Net_Amount'], align: 'left', type: 'text' },



    //{ field: 'Visa Quota  Designation SysID', header: 'Visa Status SysID', hide: true, mandatory: false, width: '4rem', data: '123456', manual: true, bind: "Alld_VisaStaus_SysID		", affects: ['Alld_Gross_Amount', 'Alld_Net_Amount'], align: 'left', type: 'number' },
    { field: 'Visa Quota  Designation Code', header: 'Visa Status Code', hide: false, mandatory: false, width: '10rem', data: '12345678912345', manual: false, bind: "Alld_VisaStaus_Code", align: 'left', type: 'text', Popup: true, PopUpData: 'visadesignationcode' },
    { field: 'Visa Quota  Designation Name', header: 'Visa Status Name', hide: false, mandatory: false, width: '15rem', data: '12345678912345', manual: false, bind: "Alld_VisaStaus_Name", affects: ['Alld_Gross_Amount', 'Alld_Net_Amount'], align: 'left', type: 'text' },


    //{ field: 'Visa Quota  Designation SysID', header: 'Passport Number', hide: true, mandatory: false, width: '4rem', data: '123456', manual: true, bind: "Alld_PassNo", affects: ['Alld_Gross_Amount', 'Alld_Net_Amount'], align: 'left', type: 'number' },
    { field: 'Visa Quota  Designation Code', header: 'Passport Issue Date', hide: false, mandatory: false, width: '10rem', data: '12345678912345', manual: false, bind: "Alld_PIssueDate", align: 'left', type: 'date' },
    { field: 'Visa Quota  Designation Name', header: 'Passport Expiry Date', hide: false, mandatory: false, width: '10rem', data: '12345678912345', manual: false, bind: "Alld_PExpDate", affects: ['Alld_Gross_Amount', 'Alld_Net_Amount'], align: 'left', type: 'date' },



    { field: 'Quota Number', header: 'Basic Salary', hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: false, bind: "Alld_BasicSalary", readOnly: true, align: 'left', type: 'number' },
    { field: 'Quota Number', header: 'Other Allowance', hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: false, bind: "Alld_OtherAllow", readOnly: true, align: 'left', type: 'number' },
    { field: 'Quota Number', header: 'Total Salary', hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: false, bind: "Alld_TotalSal", readOnly: true, align: 'left', type: 'number' },


    { field: 'Quota Number', header: 'Offer Letter Issued Date', hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: false, bind: "Alld_OfferIssue_Date", align: 'left', type: 'date' },
    { field: 'Quota Number', header: 'Visa Number', hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: false, bind: "Alld_VisaNo", readOnly: true, align: 'left', type: '' },
    { field: 'Quota Number', header: 'Visa Issue Date', hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: false, bind: "Alld_VisaIssue_Date", align: 'left', type: 'date' },



    { field: 'Quota Number', header: 'Visa Expiry Date', hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: false, bind: "Alld_VisaIssue_Date", align: 'left', type: 'date' },
    { field: 'Quota Number', header: 'Onboard date', hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: false, bind: "Alld_VisaExp_Date", align: 'left', type: 'date' },
    { field: 'Quota Number', header: 'Visa Issue Date', hide: false, mandatory: false, width: '8rem', data: '12345678912345', manual: false, bind: "Alld_OnBoard_Date", align: 'left', type: 'date' },

    //{ field: 'Remarks SysID', header: 'Remarks SysID', hide: true, mandatory: false, width: '8rem', data: '12345678912345', manual: true, bind: "Alld_Remark_SysID", affects: ['Alld_Net_Amount'], align: 'left', type: 'number' },
    { field: 'netAmount', header: 'Remarks Code', hide: false, mandatory: false, width: '10rem', data: '12345678912345', manual: false, bind: "Alld_Remark_Code", readOnly: true, align: 'left', type: 'number' },
    { field: 'landedCost', header: 'Remarks Name', hide: false, mandatory: false, width: '15rem', data: '123456789', manual: false, bind: "Alld_Remark_Name", type: 'number' },
...
CriteriaTableData = [
  ...
  // Reduced widths here
  { header: 'Criteria List Code', hide: false, mandatory: false, width: '8rem', data: '', manual: false, PopUp: true, PopUpData: 'Alld_CritCode', bind: 'Alld_Desig_Code', type: 'text' },
  { header: 'Criteria List Name', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_CritName', type: 'text' },
  ...
  // Reduced widths here
  { header: 'Remarks Code', hide: false, mandatory: false, width: '8rem', data: '', manual: false, bind: 'Alld_CritRem_Code', type: 'text', PopUp: true, PopUpData: 'RemarksCode' },
  { header: 'Remarks Name', hide: false, mandatory: false, width: '10rem', data: '', manual: false, bind: 'Alld_CritRem_Name', type: 'text' },
];
