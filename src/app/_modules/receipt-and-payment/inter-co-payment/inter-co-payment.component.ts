...
@Component({
  selector: 'app-inter-co-payment',
  templateUrl: './inter-co-payment.component.html',
  styleUrls: ['./inter-co-payment.component.scss']
})
export class InterCoPaymentComponent implements OnInit {
