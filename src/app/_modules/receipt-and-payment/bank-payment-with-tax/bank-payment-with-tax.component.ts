...
@Component({
  selector: 'app-bank-payment-with-tax',
  templateUrl: './bank-payment-with-tax.component.html',
  styleUrls: ['./bank-payment-with-tax.component.scss']
})
export class BankPaymentWithTaxComponent implements OnInit {
 FinanceSteps = [
