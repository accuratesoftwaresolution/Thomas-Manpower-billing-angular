...
@Component({
  selector: 'app-bank-receipts-with-tax',
  templateUrl: './bank-receipts-with-tax.component.html',
  styleUrls: ['./bank-receipts-with-tax.component.scss']
})
export class BankReceiptsWithTaxComponent implements OnInit {
