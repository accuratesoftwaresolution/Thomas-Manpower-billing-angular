...
@Component({
  selector: 'app-inter-co-receipt',
  templateUrl: './inter-co-receipt.component.html',
  styleUrls: ['./inter-co-receipt.component.scss']
})
export class InterCoReceiptComponent implements OnInit {
