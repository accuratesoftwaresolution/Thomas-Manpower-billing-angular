...
// async updateData(body:any,id:string): Promise<monthlyattDto[]> {
//   return await this.http.put<monthlyattDto[]>(`${environment.apiUrl}/${apiUrl.apattendanceSalary}/${id}`,body).toPromise();
// }

// async save(body: any): Promise<monthlyattDto> {
//   return this.http.post<monthlyattDto>(`${environment.apiUrl}/${apiUrl.apattendanceSalary}`,body).toPromise();
// }
